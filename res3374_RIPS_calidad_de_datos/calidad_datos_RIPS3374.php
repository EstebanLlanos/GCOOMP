...
$smarty->display('calidad_datos_RIPS3374.html.tpl');
...
if(isset($_POST["year_de_validacion"]) && isset($_POST["periodo"]) && isset($_POST["eapb"]) && $_POST["year_de_validacion"]!="" && $_POST["periodo"]!="none" && $_POST["eapb"]!="none")
{
	...
	$nombre_vista_para_calidad_de_datos="vcaldatr_".$nick_user."_".$tipo_id."_".$identificacion;
	...
	$sql_vista_calidad_de_datos.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
	...
	while($contador_offset<$numero_registros_vista)
	{
		...
		if(count($resultado_para_calidad_de_datos_desde_estado_informacion)>0 && is_array($resultado_para_calidad_de_datos_desde_estado_informacion))
		{
			...
			$nombre_archivo_calidad_de_datos=$cod_eapb."_calidad_datos_rips.csv";
			...
			if($hubo_resultados==false)
			{
				...
				$titulos.="Cod. Departamento,Departamento,Cod. Municipio,Municipio,RIPS Presentados,";
				$titulos.="RIPS Aceptados,RIPS Rechazados,Porcentaje de Aceptacion RIPS,Registros Validados,Registros Aceptados,";
				...
				$titulos.="Total Inconsistencias,Promedio Inconsistencias Obligatorias,Promedio Inconsistencias Informativas,";
			...
			foreach($resultado_para_calidad_de_datos_desde_estado_informacion as $resultado)
			{
				...
				*/
				...
				$sql_consulta_estado_informacion_2.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
				$sql_consulta_estado_informacion_2.=" (fecha_validacion BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_estado_informacion_2.=" ; ";
				$error_bd_seq="";
				$resultados_consulta_2=$coneccionBD->consultar_no_warning_get_error($sql_consulta_estado_informacion_2, $error_bd_seq);
				...
				$sql_consulta_estado_informacion_3.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
				$sql_consulta_estado_informacion_3.=" (fecha_validacion BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_estado_informacion_3.=" ; ";
				$error_bd_seq="";
				$resultados_consulta_3=$coneccionBD->consultar_no_warning_get_error($sql_consulta_estado_informacion_3, $error_bd_seq);
				...
				$sql_consulta_estado_informacion_4.=" ( ";
				$sql_consulta_estado_informacion_4.="  SUM(COALESCE(numero_registros_af,0)+COALESCE(numero_registros_us,0)+";
				$sql_consulta_estado_informacion_4.="  COALESCE(numero_registros_ac,0)+COALESCE(numero_registros_ap,0)+ ";
				$sql_consulta_estado_informacion_4.="  COALESCE(numero_registros_au,0)+COALESCE(numero_registros_ah,0)+ ";
				$sql_consulta_estado_informacion_4.="  COALESCE(numero_registros_an,0)+COALESCE(numero_registros_an,0)+ ";
				$sql_consulta_estado_informacion_4.="  COALESCE(numero_registros_at,0)+COALESCE(numero_registros_ct,0) )";
				$sql_consulta_estado_informacion_4.=" ) AS numero_registros_validados ";
				$sql_consulta_estado_informacion_4.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
				$sql_consulta_estado_informacion_4.=" (fecha_validacion BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_estado_informacion_4.=" ; ";
				$error_bd_seq="";
				$resultados_consulta_4=$coneccionBD->consultar_no_warning_get_error($sql_consulta_estado_informacion_4, $error_bd_seq);				
				...
				$sql_consulta_estado_informacion_5.=" ( ";
				$sql_consulta_estado_informacion_5.="  SUM(COALESCE(numero_registros_af,0)+COALESCE(numero_registros_us,0)+";
				$sql_consulta_estado_informacion_5.="  COALESCE(numero_registros_ac,0)+COALESCE(numero_registros_ap,0)+ ";
				$sql_consulta_estado_informacion_5.="  COALESCE(numero_registros_au,0)+COALESCE(numero_registros_ah,0)+ ";
				$sql_consulta_estado_informacion_5.="  COALESCE(numero_registros_an,0)+COALESCE(numero_registros_an,0)+ ";
				$sql_consulta_estado_informacion_5.="  COALESCE(numero_registros_at,0)+COALESCE(numero_registros_ct,0) )";
				$sql_consulta_estado_informacion_5.=" ) AS numero_registros_aceptados ";
				$sql_consulta_estado_informacion_5.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
				$sql_consulta_estado_informacion_5.=" (fecha_validacion BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_estado_informacion_5.=" ; ";
				$error_bd_seq="";
				$resultados_consulta_5=$coneccionBD->consultar_no_warning_get_error($sql_consulta_estado_informacion_5, $error_bd_seq);				
				...
				$sql_consulta_estado_informacion_6.=" ( ";
				$sql_consulta_estado_informacion_6.="  SUM(COALESCE(numero_registros_af,0)+COALESCE(numero_registros_us,0)+";
				$sql_consulta_estado_informacion_6.="  COALESCE(numero_registros_ac,0)+COALESCE(numero_registros_ap,0)+ ";
				$sql_consulta_estado_informacion_6.="  COALESCE(numero_registros_au,0)+COALESCE(numero_registros_ah,0)+ ";
				$sql_consulta_estado_informacion_6.="  COALESCE(numero_registros_an,0)+COALESCE(numero_registros_an,0)+ ";
				$sql_consulta_estado_informacion_6.="  COALESCE(numero_registros_at,0)+COALESCE(numero_registros_ct,0) )";
				$sql_consulta_estado_informacion_6.=" ) AS numero_registros_rechazados ";
				$sql_consulta_estado_informacion_6.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
				$sql_consulta_estado_informacion_6.=" (fecha_validacion BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_estado_informacion_6.=" ; ";
				$error_bd_seq="";
				$resultados_consulta_6=$coneccionBD->consultar_no_warning_get_error($sql_consulta_estado_informacion_6, $error_bd_seq);
				if(is_array($resultados_consulta_6))
				{
				...
				$sql_consulta_estado_informacion_7.=" FROM gioss_tabla_estado_informacion_rips WHERE  ";
				$sql_consulta_estado_informacion_7.=" (fecha_validacion BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_estado_informacion_7.=" ; ";
				$error_bd_seq="";
				$resultados_consulta_7=$coneccionBD->consultar_no_warning_get_error($sql_consulta_estado_informacion_7, $error_bd_seq);
				...
				if(is_array($resultados_consulta_7))
				{
					foreach($resultados_consulta_7 as $numero_secuencia_actual)
					{
						...
						$query_numero_inconsistencias_obligatorias.="SELECT count(*) AS numero_inconsistencias_obligatorias FROM gioss_reporte_inconsistencia_archivos_rips ";
						...
						$query_numero_inconsistencias_obligatorias.=" (cod_tipo_inconsitencia='01' OR cod_tipo_inconsitencia='03' OR cod_tipo_inconsitencia='04') ";
						$query_numero_inconsistencias_obligatorias.=" ; ";
						$resultados_consulta_inconsistencias_obligatorias=$coneccionBD->consultar_no_warning_get_error($query_numero_inconsistencias_obligatorias, $error_bd_seq);
						...
						$query_numero_inconsistencias_informativas.="SELECT count(*) AS numero_inconsistencias_informativas FROM gioss_reporte_inconsistencia_archivos_rips ";
						...
						$query_numero_inconsistencias_informativas.=" (cod_tipo_inconsitencia='02') ";
						$query_numero_inconsistencias_informativas.=" ; ";
						$resultados_consulta_inconsistencias_obligatorias=$coneccionBD->consultar_no_warning_get_error($query_numero_inconsistencias_informativas, $error_bd_seq);
						...
						$query_registros_malos.=" FROM gioss_reporte_inconsistencia_archivos_rips WHERE ";
						$query_registros_malos.=" cod_tipo_inconsitencia='01' OR cod_tipo_inconsitencia='03' OR cod_tipo_inconsitencia='04' ORDER BY numero_linea ";
						$query_registros_malos.=" ; ";
						$error_bd_seq="";
						$bool_hubo_error_query=$coneccionBD->insertar_no_warning_get_error($query_registros_malos, $error_bd_seq);
						if($error_bd_seq!="")
						{
						...
						$resultados_lineas_malas=$coneccionBD->consultar_no_warning_get_error($query_consulta_lineas_malas, $error_bd_seq);
				...
				$promedio_inconsistencias_obligatorias=round((floatval($numero_inconsistencias_obligatorias)/floatval($numero_registros_validados))*100,1,PHP_ROUND_HALF_UP);
				$linea_estado_informacion.=$promedio_inconsistencias_obligatorias.",";//
				
				$promedio_inconsistencias_informativas=0;
				$promedio_inconsistencias_informativas=round((floatval($numero_inconsistencias_informativas)/floatval($numero_registros_validados))*100,1,PHP_ROUND_HALF_UP);
				$linea_estado_informacion.=$promedio_inconsistencias_informativas.",";//
				
				$promedio_inconsistencias=0;
				$promedio_inconsistencias=round((floatval($total_inconsistencias)/floatval($numero_registros_validados))*100,1,PHP_ROUND_HALF_UP);
				$linea_estado_informacion.=$promedio_inconsistencias.",";//
				
				$numero_registros_buenos="";
				$numero_registros_buenos=floatval($numero_registros_validados)-$acc_lineas_malas;
				$linea_estado_informacion.=$numero_registros_buenos.",";//
				
				$numero_registros_malos="";
				$numero_registros_malos=$acc_lineas_malas;
				$linea_estado_informacion.=$numero_registros_malos.",";//
				
				$porcentaje_registros_malos="";
				$porcentaje_registros_malos=round((floatval($numero_registros_malos)/floatval($numero_registros_validados))*100,1,PHP_ROUND_HALF_UP);
				$linea_estado_informacion.=$porcentaje_registros_malos.",";//
				
				$porcentaje_de_registros_correctos="";
				$porcentaje_de_registros_correctos=round((floatval($numero_registros_buenos)/floatval($numero_registros_validados))*100,1,PHP_ROUND_HALF_UP);
	...
	if($hubo_resultados)
	{
		...
		$boton_descarga=" <input type=\'button\' value=\'Descargar archivo con el reporte de calidad de datos para RIPS\'  class=\'btn btn-success color_boton\' onclick=\"download_archivo(\'$ruta_archivo_calidad_de_datos\');\"/> ";
