...
function enviar()
{
	...
	{
		mensaje_error+="Seleccione el estado de la informaci&oacuten de los reportes VIH 4725.<br></br>";
	}
	
	if($('#periodo').val()=="none" && document.getElementById("tipo_consulta_radio_detallado").checked == true)
	{
		mensaje_error+="Seleccione el periodo de los reportes  VIH 4725.<br></br>";
	}
	
	if($('#eapb').val()=="none")
	{
		mensaje_error+="Seleccione la entidad administradora EAPB para el cual reportara VIH 4725.<br></br>";
	}
