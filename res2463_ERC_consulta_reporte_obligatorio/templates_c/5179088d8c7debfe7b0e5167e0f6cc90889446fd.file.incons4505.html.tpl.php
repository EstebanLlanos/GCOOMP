<?php /* Smarty version Smarty-3.1.17, created on 2014-07-01 08:32:34
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="incons4505.php" method="post">
						...
						<h5 style="color:blue;">Seleccione la forma en que desea buscar las inconsistencias de los archivos PyP 4545:</h5>
						<br>
						&#32
						</td>
						</tr>
