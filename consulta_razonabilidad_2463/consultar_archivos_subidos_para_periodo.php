	...
	)
{
	...
	$query_archivos_subidos_para_analisis.=" SELECT aa.* , eva.nick_usuario FROM gioss_indice_archivo_para_analisis_0247 aa LEFT JOIN gioss_4505_esta_validando_actualmente eva ON (aa.fecha_y_hora_validacion::text = concat_ws(' ',eva.fecha_validacion::text,eva.hora_validacion::text) AND aa.nombre_archivo=aa.nombre_archivo)
