<?php /* Smarty version Smarty-3.1.17, created on 2018-01-02 11:31:38
         compiled from "consulta_razonabilidad_2463.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13384486155a4bb3ead9bb75-55789284%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bbd1a246a081ad98555ec50c78ff1e748ff5dc96' => 
    array (
      0 => 'consulta_razonabilidad_2463.html.tpl',
      1 => 1514910663,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13384486155a4bb3ead9bb75-55789284',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4bb3eadbf890_65940942',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4bb3eadbf890_65940942')) {function content_5a4bb3eadbf890_65940942($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="consulta_razonabilidad_2463.js?v=1.592"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="consulta_razonabilidad_2463.css?v=1.0" rel="stylesheet" />
       <title>Consulta Razonabilidad 2463</title>
					...
					<form name="formulario" id="formulario" action="" method="post" enctype= "multipart/form-data">
						...
						<tr>
						    <td style="text-align:left;">
						    	<h4 style="color:#0000FF;text-shadow: 2px 2px 5px #A8A8FF;">Analisis para 2463 Enfermedad Renal Cronica</h4>
						    </td>
					    </tr>
						...
						<tr>
							<td style="text-align:left;">
							    <div id='div_para_consultas_cruzadas' style='display:none;'>
							    	...
							    	<input type='button' id='boton_adicionar_campo' name='boton_adicionar_campo' class='btn btn-success color_boton' value='Cruzar Con campo Adicional (+)' onclick='adicionar_campo_para_cruce();' style='display:none;'/>		
