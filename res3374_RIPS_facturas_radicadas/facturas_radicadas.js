...
$(function() {
    ...
    $("#fecha_radicacion").datepicker("option", "dateFormat", 'mm/dd/yy');
    $("#fecha_radicacion").datepicker($.datepicker.regional[ "es" ]);
});

$(function() {
    $("#fecha_factura").datepicker();
    $("#fecha_factura").datepicker("option", "dateFormat", 'mm/dd/yy');
