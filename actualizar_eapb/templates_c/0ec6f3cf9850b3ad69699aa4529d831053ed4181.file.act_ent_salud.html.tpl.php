<?php /* Smarty version Smarty-3.1.17, created on 2014-04-25 21:02:06
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post" enctype= "multipart/form-data">
						...
						por lo tanto los campos deber&aacuten estar organizados en la siguiente forma (NOTA: un numero diferente de comas evitara que se suba el archivo):
						cod_tipo_entidad,des_tipo_entidad_salud	codigo_entidad_salud,nombre_entidad_salud,numero_identificacion,digito_verificacion	cod_depto,Cod_mpio
						</p>
						</td>
						</tr>
