<?php /* Smarty version Smarty-3.1.17, created on 2014-09-27 11:36:01
         compiled from "cumplimiento_info_fact_RIPS3374.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2824654190db859f9b0-39588778%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '472da8f5325f9bf7e53e4b412dd3157c49129d32' => 
    array (
      0 => 'cumplimiento_info_fact_RIPS3374.html.tpl',
      1 => 1411416532,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2824654190db859f9b0-39588778',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_54190db8eb00d3_62770572',
  'variables' => 
  array (
    'menu' => 1,
    'nombre' => 1,
...
<?php if ($_valid && !is_callable('content_54190db8eb00d3_62770572')) {function content_54190db8eb00d3_62770572($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">       
        <script type="text/javascript" src="../librerias_externas/jquery_min/jquery-1.10.2.js"> </script>       
        <script type="text/javascript" src="cumplimiento_info_fact_RIPS3374.js"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="cumplimiento_info_fact_RIPS3374.css" rel="stylesheet" />
       <title>Cumplimiento Factura</title>
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario"  method="post">
						...
						<h5 style="color:blue;">REPORTE DE CUMPLIMIENTO DE FACTURAS RIPS(EAPB):</h5>
						<br>
						&#32
						</td>
						</tr>
						...
						<table>
						<tr>
						<td style="text-align:left;"><b>Fecha de Radicaci&oacuten de la factura:</b></td>
						</tr>
						<tr>
						<td style="text-align:left;">
						<input type='text' id='year_de_radicacion' name='year_de_radicacion' class='campo_azul' placeholder='AAAA' maxlength="4" onkeypress="return isNumberKey(event)" onchange="mostrar_meses();" onkeyup="mostrar_meses();" />
 ...
 <div id='mostrar_mpio' style='display:inline;'><?php echo $_smarty_tpl->tpl_vars['campo_mpio']->value;?>
						...
						<table>
						<tr>
						<td style="text-align:left;"><b>Fecha de validaci&oacuten:</b></td>
						</tr>
						<tr>
						<td style="text-align:left;">
