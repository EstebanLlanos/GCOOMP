...
function enviar()
{
	...
	/*	
	if ($('input[name=tipo_busqueda_inconsistencias]:checked').length == 0)
	{
		// do something here
		mensaje_error+="Seleccione el la clasificacion de inconsistencias por el cual desea realizar el consolidado.<br></br>";
	}
	*/
	if($('#eapb').val()=="none")
	{
