...
$smarty->display('estruct_incons_prest_4505.html.tpl');
...
if(isset($_POST["year_de_validacion"]) 
   && isset($_POST["eapb"]) && $_POST["eapb"]!="none" && ($_POST["year_de_validacion"]==""||ctype_digit($_POST["year_de_validacion"])))
{
	...
	*/
	...
	$sql_vista_estruct_incons_prest.=" FROM gioss_tabla_estado_informacion_4505 tei ";
	$sql_vista_estruct_incons_prest.=" INNER JOIN gioss_reporte_inconsistencia_archivos_4505 ri on (tei.numero_secuencia=ri.numero_orden )";
	...
	if($year!="")
	{
		...
		$sql_vista_estruct_incons_prest.=" (fecha_corte_periodo BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
	...
	while($contador_offset<$numero_registros_vista)
	{
		...
		if(count($resultado_para_calidad_de_datos_desde_estado_informacion)>0 && is_array($resultado_para_calidad_de_datos_desde_estado_informacion))
		{
			...
			foreach($resultado_para_calidad_de_datos_desde_estado_informacion as $resultado)
			{
				...
				$query_consulta_inconsistencias.="SELECT * FROM gioss_detalle_inconsistecias_4505 ";
				$query_consulta_inconsistencias.=" WHERE codigo_detalle_inconsistencia='".$resultado["cod_detalle_inconsistencia"]."';";
				$error_bd_seq="";
				...
				{
					$linea_estado_informacion.=$resultados_consulta_detalles_inconsistencias[0]["codigo_tipo_inconsistencia"].",";
					$query_desc_tipo_incons="SELECT * FROM gioss_tipo_inconsistencias WHERE tipo_validacion='".$resultados_consulta_detalles_inconsistencias[0]["codigo_tipo_inconsistencia"]."';";
					$error_bd_seq="";
					...
					$linea_estado_informacion.=$resultados_consulta_detalles_inconsistencias[0]["codigo_detalle_inconsistencia"].",";
					$linea_estado_informacion.=explode(";;",$resultados_consulta_detalles_inconsistencias[0]["descripcion_inconsistencia"])[1].",";
				}
				...
				$sql_consulta_cantidad_inconsistencias_periodo_1.=" FROM gioss_tabla_estado_informacion_4505 tei ";
				$sql_consulta_cantidad_inconsistencias_periodo_1.=" LEFT JOIN gioss_reporte_inconsistencia_archivos_4505 ri on (tei.numero_secuencia=ri.numero_orden )";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_1.=" periodo_reporte='1' ";
				$sql_consulta_cantidad_inconsistencias_periodo_1.=" AND ";
				...
				{
					$sql_consulta_cantidad_inconsistencias_periodo_1.=" AND ";
					$sql_consulta_cantidad_inconsistencias_periodo_1.=" (fecha_corte_periodo BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_2.=" FROM gioss_tabla_estado_informacion_4505 tei ";
				$sql_consulta_cantidad_inconsistencias_periodo_2.=" LEFT JOIN gioss_reporte_inconsistencia_archivos_4505 ri on (tei.numero_secuencia=ri.numero_orden )";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_2.=" periodo_reporte='2' ";
				$sql_consulta_cantidad_inconsistencias_periodo_2.=" AND ";
				...
				{
					$sql_consulta_cantidad_inconsistencias_periodo_2.=" AND ";
					$sql_consulta_cantidad_inconsistencias_periodo_2.=" (fecha_corte_periodo BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_3.=" FROM gioss_tabla_estado_informacion_4505 tei ";
				$sql_consulta_cantidad_inconsistencias_periodo_3.=" LEFT JOIN gioss_reporte_inconsistencia_archivos_4505 ri on (tei.numero_secuencia=ri.numero_orden )";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_3.=" periodo_reporte='3' ";
				$sql_consulta_cantidad_inconsistencias_periodo_3.=" AND ";
				...
				{
					$sql_consulta_cantidad_inconsistencias_periodo_3.=" AND ";
					$sql_consulta_cantidad_inconsistencias_periodo_3.=" (fecha_corte_periodo BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_4.=" FROM gioss_tabla_estado_informacion_4505 tei ";
				$sql_consulta_cantidad_inconsistencias_periodo_4.=" LEFT JOIN gioss_reporte_inconsistencia_archivos_4505 ri on (tei.numero_secuencia=ri.numero_orden )";
				...
				$sql_consulta_cantidad_inconsistencias_periodo_4.=" periodo_reporte='4' ";
				$sql_consulta_cantidad_inconsistencias_periodo_4.=" AND ";
				...
				{
					$sql_consulta_cantidad_inconsistencias_periodo_4.=" AND ";
					$sql_consulta_cantidad_inconsistencias_periodo_4.=" (fecha_corte_periodo BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
				...
				$sql_consulta_cantidad_total_inconsistencias_todos_los_prestadores.=" FROM gioss_tabla_estado_informacion_4505 tei ";
				$sql_consulta_cantidad_total_inconsistencias_todos_los_prestadores.=" LEFT JOIN gioss_reporte_inconsistencia_archivos_4505 ri on (tei.numero_secuencia=ri.numero_orden )";
				...
				if($year!="")
				{
					...
					$sql_consulta_cantidad_total_inconsistencias_todos_los_prestadores.=" (fecha_corte_periodo BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
