...
/*
$sql_prestadores_asociados_al_archivo="SELECT * FROM gioss_archivo_para_analisis_0123 
...
$sql_query_valores_permitidos="SELECT * FROM valores_permitidos_0123 order by numero_campo_norma::numeric asc; ";
...
$query_archivos_subidos_para_analisis.=" SELECT * FROM gioss_indice_archivo_para_analisis_0123 ORDER BY fecha_y_hora_validacion asc ; ";
...
$smarty->display('consulta_cruces_0123.html.tpl');

/*
INSERT INTO gios_menus_opciones_sistema(id_principal,id_padre,nombre_opcion,descripcion_ayuda,tiene_submenus,ruta_interfaz,prioridad_jerarquica) VALUES ('225','175','Consulta Cruces','',FALSE,'..|consulta_cruces_0123|consulta_cruces_0123.php','33.02');

INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('225','5'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('225','4'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('225','3'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('225','2'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('225','1'); 
*/
	...
	else if($selector_rango_conteo=='specific_allips')
	{
		...
		if($agrupado_o_detallado=="conteo")
		{
			...
			if($cont_campos==95)
			{
				...
				if(is_array($resultado_query_conteo_campo) && count($resultado_query_conteo_campo) )
				{
					$array_resultado=lista_valores_permitidos_campo($numero_campo,$coneccionBD);//95 edad years
					$descripcion_campo=$array_resultado['descripcion_campo'];
					$array_valores_permitidos=$array_resultado['valores_permitidos'];
					$keys_valores_permitidos=array_keys($array_valores_permitidos);
		...
		else if($agrupado_o_detallado=="detallado")
		{
			...
			if($cont_campos<95)
			{
				...
				{
					$query_conteo_campo.=" from gioss_archivo_para_analisis_0123  
					WHERE 
					nombre_archivo='$nombre_archivo_identificador'
					AND fecha_y_hora_validacion='$fecha_y_hora_validacion_identificador'
					AND fecha_de_corte='$fecha_de_corte_identificador'
			...
			if($selector_all_or_one_vp=="allvp")
			{
				if($selector_general_o_detallado_cross=="conteo")
				{
					...
					foreach ($array_campos_cruzados_seleccionados as $key => $numero_campo_cruzado) 
					{
						...
						if(intval($numero_campo_cruzado)<95)
						{
						...
						else if(intval($numero_campo_cruzado)==95)
						{
							...
							if($numero_campo_base!=$numero_campo_cruzado)
							{
								...
								foreach ($listado_vp_para_los_campos_cruzados[$numero_campo_cruzado]['valores_permitidos_puros'] as $key => $valor_permitido_puro_campo_secundario) 
								{
									...
									foreach ($resultado_query_conteo_campos_cruzados as $key => $resultado_cruce) 
									{
										...
										$nombre_campo_base="";
										if(intval($numero_campo_base)<95)
										{
											$nombre_campo_base='campo'.$numero_campo_base;
										}//fin if
										else if(intval($numero_campo_base)>=95)
										{
