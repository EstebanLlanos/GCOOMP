   ...
   )
{
	...
	if($norma=="norma_4505")
	{
		...
		$query_descartar_archivo_4505.=" SET se_pudo_descargar='SI' ";
	...
	if($norma=="norma_0123")
	{
		...
		$query_descartar_archivo_0123.=" SET se_pudo_descargar='SI' ";
	...
	if($norma=="norma_0247")
	{
		...
		$query_descartar_archivo_0247.=" SET se_pudo_descargar='SI' ";
	...
	if($norma=="norma_4725")
	{
		...
		$query_descartar_archivo_4725.=" SET se_pudo_descargar='SI' ";
	...
	if($norma=="norma_2463")
	{
		...
		$query_descartar_archivo_2463.=" SET se_pudo_descargar='SI' ";
	...
	if($norma=="norma_1393")
	{
		...
		$query_descartar_archivo_1393.=" SET se_pudo_descargar='SI' ";
