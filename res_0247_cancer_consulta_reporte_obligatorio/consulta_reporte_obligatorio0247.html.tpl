			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post">
						...
						<tr>
						<td style="text-align:left;position:relative;">{$campo_periodo}<div id='fecha_corte_periodo_actual' name='fecha_corte_periodo_actual' style="position:absolute;left:25%;top:5%" onchange="consultar_fecha_generacion_usuario();"></div></td>
						</tr>
