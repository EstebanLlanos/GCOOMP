...
if(isset($_REQUEST["prestador"]) && isset($_REQUEST["nombre_archivo"]) &&  $_REQUEST["nombre_archivo"]!="" && $_REQUEST["prestador"]!="none" )
{
	...
	//parte base de datos
	$query_consulta="";
	$query_consulta.="SELECT numero_secuencia FROM gioss_numero_de_secuencia_r0247_cancer WHERE ";
	...
	{		
		...
		$selector_numeros_remision.="<option value='none' selected>Seleccione un numero de secuencia de los asociados al archivo CANCER 0247</option>";
