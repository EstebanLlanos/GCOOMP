<html>
<head>
<title>Subir tabla_divi_pola_rips</title>
...
$archivo_prestadores = fopen("tabla_divi_pola_rips.csv", 'r') or exit("No se pudo abrir el archivo con las entidades prestadoras");
$archivo_queries = fopen("tabla_divi_pola_rips.sql", "w") or die("fallo la creacion del archivo");
$archivo_error= fopen("tabla_divi_pola_rips.error", "w") or die("fallo la creacion del archivo");
$cont_reset_div=0;
$cont_linea=0;
$error="";
$error_para_txt="";
while (!feof($archivo_prestadores)) 
{
	...
	/*
	codigo_departamento character varying(320),
	codigo_municipio  character varying(320),
	codigo_centro_poblado  character varying(320),
	nombre_departamento character varying(320),
	nombre_municipio character varying(320),
	nombre_centro_poblado character varying(320),
	tipo character varying(320),
	*/
	if($linea_res!="")
	{
		$sql_insert="";
		//INICIA QUERY INSERT gioss_tabla_divi_pola_rips
		$sql_insert.="insert into gioss_tabla_divi_pola_rips ";
		$sql_insert.="(";
		$sql_insert.="codigo_departamento,codigo_municipio,codigo_centro_poblado,";
		$sql_insert.="nombre_departamento,nombre_municipio,nombre_centro_poblado,";
		$sql_insert.="tipo";
		$sql_insert.=")";
		$sql_insert.="values";
		$sql_insert.="(";
		...
		$sql_insert.=");";
		//FIN QUERY INSERT gioss_tabla_divi_pola_rips
