<html>
<head>
<title>Subir entidades de salud</title>
...
$archivo_queries = fopen("gioss_entidades_sector_salud.sql", "w") or die("fallo la creacion del archivo");
$cont_reset_div=0;
$cont_linea=0;
while (!feof($archivo_prestadores)) 
{
	...
	/*
	  ...
	  codigo_entidad_salud character varying(320) NOT NULL,
	  nombre_entidad_salud character varying(320),
	...
	*/
	if($linea_res!="")
	{
		...
		$sql_insert.="(";
		$sql_insert.="cod_tipo_entidad,codigo_entidad_salud,";
		$sql_insert.="nombre_entidad_salud,numero_identificacion,digito_verificacion,";
		$sql_insert.="codigo_dpto,cod_mpio";
		$sql_insert.=")";
		$sql_insert.="values";
		$sql_insert.="(";
		$cont_campos=0;
