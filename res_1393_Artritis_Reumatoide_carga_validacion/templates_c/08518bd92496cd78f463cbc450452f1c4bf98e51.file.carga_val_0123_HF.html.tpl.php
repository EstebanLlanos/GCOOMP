<?php /* Smarty version Smarty-3.1.17, created on 2015-04-09 16:11:55
         compiled from "carga_val_0123_HF.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:757154e1de231e87c8-01997991%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '757154e1de231e87c8-01997991',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_54e1de23b5e800_32373921',
  'variables' => 
  array (
    'menu' => 1,
    'nombre' => 1,
...
<?php if ($_valid && !is_callable('content_54e1de23b5e800_32373921')) {function content_54e1de23b5e800_32373921($_smarty_tpl) {?><!DOHFYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="carga_val_0123_HF.js"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="carga_val_0123_HF.css" rel="stylesheet" />
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post" enctype= "multipart/form-data">
						...
						<h5>Formulario de carga y validacion de documentos 0123 para Hemofilia</h5>
						</td>
						</tr>
						...
						<td style="text-align:right;width:40.05%;">
							<table id='tabla_seleccion_archivos' style='display:inline;'>
								...
								<div class="upload"><input type="file" id='0123_HF_file' name='0123_HF_file' style="cursor:pointer;" onchange="obtener_nombre_file_upload('0123_HF_file','nombre_archivo_0123');verificar_nombre_archivo(this.value,'AR','nombre_archivo_0123');" onclick="obtener_nombre_file_upload('0123_HF_file','nombre_archivo_0123');verificar_nombre_archivo(this.value,'AR','nombre_archivo_0123');" /></div>
								</td>
								
								<td style="position:absolute;left:-50%;top:15%;">
								<div id='nombre_archivo_0123'></div>
								</td>
