...
$smarty->display('prestadorRIPS3374.html.tpl');
...
{	
	...
	$sql_numero_registros.="SELECT count(*) as contador FROM gioss_tabla_estado_informacion_rips WHERE codigo_prestador_servicios='$prestador'  ";		
	...
	$sql_vista_estado_informacion.=" AS SELECT * FROM gioss_tabla_estado_informacion_rips WHERE codigo_prestador_servicios='$prestador'  ";
	...
	while($contador_offset<$numero_registros)
	{
		...
		{
			$nombre_archivo_estado_informacion=$prestador."_estado_info_rips.csv";
