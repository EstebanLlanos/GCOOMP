...
$query_periodos_rips="SELECT * FROM gioss_periodo_reporte_r4725_sida_vih;";
...
$smarty->display('repobligVIH4725.html.tpl');
...
if(isset($_POST["year_de_corte"]) && isset($_POST['eapb']) && $_POST['eapb']!="none" && $_POST["year_de_corte"]!="" && ctype_digit($_POST["year_de_corte"]) )
{
	...
	$nombre_zip_sin_consecutivo=$array_fcbd[2].$array_fcbd[0].$array_fcbd[1]."_".$string_cod_eapb."_"."VIH";
	...
	$query_verificacion_esta_siendo_procesado.=" SELECT * FROM gioss_4725_esta_consolidando_ro_actualmente ";
	...
	$query_verificar_nombre_archivo="SELECT * FROM gioss_archivos_obligatorios_reportados_sida WHERE codigo_entidad_eapb_generadora='$cod_eapb' AND nombre_archivo_vih_sida='$nombre_zip_sin_consecutivo' ;";
		...
		if(isset($array_permisos[0]))
		{
			if($array_permisos[0]=="SI")
			{
				...
				if($accion=="validada" && count($resultado_verificar_nombre_archivo)>0 )
				{
					...
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_sida4725_exitoso ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_vih_sida='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					...
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_sida4725_exitoso_duplicado ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_vih_sida='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
					...
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_dupl_incluidos_excluidos_hor_sida4725 ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_sida='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
					{
				...
				{
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_sida4725_rechazado ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_vih_sida='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
	...
	if($ya_se_reporto_archivo==false)
	{
		...
		$query_insert_esta_siendo_procesado.=" INSERT INTO gioss_4725_esta_consolidando_ro_actualmente ";
		$query_insert_esta_siendo_procesado.=" ( ";
		...
		$sql_datos_reporte_obligatorio.="CREATE OR REPLACE VIEW vsrovih_".$nick_user."_".$tipo_id."_".$identificacion." ";
		$sql_datos_reporte_obligatorio.=" AS  ";	
		if($accion=="validada")
		{
			$sql_datos_reporte_obligatorio .=" ( ";
			$sql_datos_reporte_obligatorio .=" SELECT * from gioss_tabla_registros_cargados_exito_r4725_sida WHERE ";			
			...
			$sql_datos_reporte_obligatorio .=" SELECT * from gioss_tabla_registros_no_cargados_rechazados_r4725_sida WHERE ";			
			$sql_datos_reporte_obligatorio .=" (fecha_corte BETWEEN '".$fecha_ini_bd."'  AND '".$fecha_fin_bd."' )  ";
			$sql_datos_reporte_obligatorio .=" AND ";
			$sql_datos_reporte_obligatorio .=" estado_registro='1' ";
			$sql_datos_reporte_obligatorio .=" AND ";
		...
		$sql_query_numero_registros.="SELECT count(*) as contador FROM vsrovih_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		...
		//SUBIDA A TABLA CONSULTA VIH Y ESCRIBIENDO EN EL ARCHIVO
		...
		while($contador_offset<$numero_registros)
		{
			...
			$verificar_si_ejecucion_fue_cancelada.=" SELECT esta_ejecutando FROM gioss_4725_esta_consolidando_ro_actualmente ";
			...
			$sql_query_busqueda="";
			$sql_query_busqueda.="SELECT * FROM vsrovih_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite OFFSET $contador_offset;  ";
			...
			foreach($resultados_query_vih as $linea_consulta)
			{
				...
				$regimen_afiliacion=$linea_consulta["campo_sida_de_numero_orden_2"];
				...
				if($accion=="validada")
				{
					$sql_delete_duplicados.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso ";
				}
				else if($accion=="rechazada")
				{
					$sql_delete_duplicados.=" gioss_consulta_reporte_obligatorio_sida4725_rechazado ";
				}
				...
				$sql_delete_duplicados.=" AND ";
				$sql_delete_duplicados.=" campo_sida_de_numero_orden_8='".trim($linea_consulta["campo_sida_de_numero_orden_8"])."'  ";
				$sql_delete_duplicados.=" AND ";
				$sql_delete_duplicados.=" campo_sida_de_numero_orden_9='".trim($linea_consulta["campo_sida_de_numero_orden_9"])."'  ";
				$sql_delete_duplicados.=" ; ";
				$error_bd_seq="";		
				...
				*/
				...
				if($accion=="validada")
				{
					...
					$sql_hubo_en_duplicados.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso_duplicado ";
					...
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" nombre_archivo_vih_sida='".$nombre_zip_sin_consecutivo."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_sida_de_numero_orden_8='".trim($linea_consulta["campo_sida_de_numero_orden_8"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_sida_de_numero_orden_9='".trim($linea_consulta["campo_sida_de_numero_orden_9"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" ( ";
					...
					if(count($registros_desde_tabla_duplicados)>0 && is_array($registros_desde_tabla_duplicados))
					{
						...
						$sql_insert_duplicados_rep_oblig_sida="";
						$sql_insert_duplicados_rep_oblig_sida.=" INSERT INTO ";
						$sql_insert_duplicados_rep_oblig_sida.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso_duplicado ";				
						$sql_insert_duplicados_rep_oblig_sida.=" ( ";				
						$cont_orden_campo_sida=0;
						while($cont_orden_campo_sida<=184)
						{
							$sql_insert_duplicados_rep_oblig_sida.=" campo_sida_de_numero_orden_".$cont_orden_campo_sida." , ";
							$cont_orden_campo_sida++;
						}//fin while para nombres columnas de bd correspondientes a los campos de 4725 a insertar				
						$sql_insert_duplicados_rep_oblig_sida.=" numero_secuencia, ";
						$sql_insert_duplicados_rep_oblig_sida.=" numero_registro, ";
						$sql_insert_duplicados_rep_oblig_sida.=" regimen, ";
						$sql_insert_duplicados_rep_oblig_sida.=" fecha_corte_reporte, ";
						$sql_insert_duplicados_rep_oblig_sida.=" fecha_de_generacion, ";
						$sql_insert_duplicados_rep_oblig_sida.=" hora_generacion, ";
						$sql_insert_duplicados_rep_oblig_sida.=" codigo_entidad_eapb_generadora, ";
						$sql_insert_duplicados_rep_oblig_sida.=" codigo_entidad_prestadora, ";
						$sql_insert_duplicados_rep_oblig_sida.=" nombre_archivo_vih_sida ";
						$sql_insert_duplicados_rep_oblig_sida.=" ) ";
						$sql_insert_duplicados_rep_oblig_sida.=" VALUES ";
						$sql_insert_duplicados_rep_oblig_sida.=" ( ";				
						$cont_orden_campo_sida=0;
						while($cont_orden_campo_sida<=184)
						{
							$sql_insert_duplicados_rep_oblig_sida.="'".alphanumericAndSpace($linea_consulta["campo_sida_de_numero_orden_".$cont_orden_campo_sida])."',";
							$cont_orden_campo_sida++;
						}//fin while con los valores de los campos 4725 a insertar en la tabla de reporte obligatorio
						$sql_insert_duplicados_rep_oblig_sida.="'".$linea_consulta["numero_secuencia"]."',";
						$sql_insert_duplicados_rep_oblig_sida.="'".$linea_consulta["fila"]."',";				
						$sql_insert_duplicados_rep_oblig_sida.="'".$regimen_almacenado."',";								
						$sql_insert_duplicados_rep_oblig_sida.="'".$fecha_corte_bd."',";
						$sql_insert_duplicados_rep_oblig_sida.="'".$fecha_actual."',";
						$sql_insert_duplicados_rep_oblig_sida.="'".$tiempo_actual."',";
						$sql_insert_duplicados_rep_oblig_sida.="'".$linea_consulta["codigo_eapb_a_reportar"]."',";
						$sql_insert_duplicados_rep_oblig_sida.="'".$linea_consulta["codigo_prestador_reportante"]."',";
						$sql_insert_duplicados_rep_oblig_sida.="'".$nombre_zip_sin_consecutivo."'";
						$sql_insert_duplicados_rep_oblig_sida.=" ) ";
						$sql_insert_duplicados_rep_oblig_sida.=" ; ";
						$error_bd_seq="";		
						$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($sql_insert_duplicados_rep_oblig_sida, $error_bd_seq);
						if($error_bd_seq!="")
						{
					...
					$sql_query_ultimo_dejado.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso ";
					...
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" nombre_archivo_vih_sida='".$nombre_zip_sin_consecutivo."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_sida_de_numero_orden_8='".trim($linea_consulta["campo_sida_de_numero_orden_8"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_sida_de_numero_orden_9='".trim($linea_consulta["campo_sida_de_numero_orden_9"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" ( ";
					...
					if(count($registro_ultimo_dejado)>0 && is_array($registro_ultimo_dejado))
					{
						...
						foreach($registro_ultimo_dejado as $ultimo_registro)
						{
							...
							while($cont_orden_campo_sida<=184)
							{
								$sql_insert_duplicados_rep_oblig_sida.="'".alphanumericAndSpace($ultimo_registro["campo_sida_de_numero_orden_".$cont_orden_campo_sida])."',";
								$cont_orden_campo_sida++;
							}//fin while con los valores de los campos 4725 a insertar en la tabla de reporte obligatorio
							$sql_insert_duplicados_rep_oblig_sida.="'".$ultimo_registro["numero_secuencia"]."',";
							$sql_insert_duplicados_rep_oblig_sida.="'".$ultimo_registro["numero_registro"]."',";	
							$sql_insert_duplicados_rep_oblig_sida.="'".$regimen_almacenado."',";								
							$sql_insert_duplicados_rep_oblig_sida.="'".$fecha_corte_bd."',";
							$sql_insert_duplicados_rep_oblig_sida.="'".$fecha_actual."',";
							$sql_insert_duplicados_rep_oblig_sida.="'".$tiempo_actual."',";
							$sql_insert_duplicados_rep_oblig_sida.="'".$ultimo_registro["codigo_entidad_eapb_generadora"]."',";
							$sql_insert_duplicados_rep_oblig_sida.="'".$ultimo_registro["codigo_entidad_prestadora"]."',";
							$sql_insert_duplicados_rep_oblig_sida.="'".$nombre_zip_sin_consecutivo."'";
							$sql_insert_duplicados_rep_oblig_sida.=" ) ";
							$sql_insert_duplicados_rep_oblig_sida.=" ; ";
							$error_bd_seq="";		
					...
					$sql_delete_duplicados.=" codigo_entidad_eapb_generadora='".$cod_eapb."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" nombre_archivo_vih_sida='".$nombre_zip_sin_consecutivo."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_sida_de_numero_orden_8='".trim($linea_consulta["campo_sida_de_numero_orden_8"])."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_sida_de_numero_orden_9='".trim($linea_consulta["campo_sida_de_numero_orden_9"])."'  ";
				...
				if($hubo_duplicado==false)
				{
					...
					if($accion=="validada")
					{
						$sql_insert_consulta_reporte_obligatorio.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso ";
					}
					else if($accion=="rechazada")
					{
						$sql_insert_consulta_reporte_obligatorio.=" gioss_consulta_reporte_obligatorio_sida4725_rechazado ";
					}
					$sql_insert_consulta_reporte_obligatorio.=" ( ";
					$cont_orden_campo_sida=0;
					while($cont_orden_campo_sida<=184)
					{
						$sql_insert_consulta_reporte_obligatorio.=" campo_sida_de_numero_orden_".$cont_orden_campo_sida." , ";
						$cont_orden_campo_sida++;
					}
					...
					$sql_insert_consulta_reporte_obligatorio.=" nombre_archivo_vih_sida ";
					$sql_insert_consulta_reporte_obligatorio.=" ) ";
					...
					while($cont_orden_campo_sida<=184)
					{
						$sql_insert_consulta_reporte_obligatorio.="'".alphanumericAndSpace($linea_consulta["campo_sida_de_numero_orden_".$cont_orden_campo_sida])."',";
						$cont_orden_campo_sida++;
					}
			...
			$query_update_esta_siendo_procesado.=" UPDATE gioss_4725_esta_consolidando_ro_actualmente ";
		...
		//FIN SUBIDA A TABLA CONSULTA  VIH Y ESCRIBIENDO EN EL ARCHIVO
		...
		if($accion=="validada" && $hubo_al_menos_un_duplicado==true)
		{
			...
			$sql_vista_duplicados_reporte_obligatorio.="CREATE OR REPLACE VIEW vduplsida_".$nick_user."_".$tipo_id."_".$identificacion." ";
			$sql_vista_duplicados_reporte_obligatorio.=" AS  ";					
			$sql_vista_duplicados_reporte_obligatorio .="SELECT * from gioss_consulta_reporte_obligatorio_sida4725_exitoso_duplicado WHERE ";				
			...
			$sql_vista_duplicados_reporte_obligatorio.=" AND ";
			$sql_vista_duplicados_reporte_obligatorio.=" nombre_archivo_vih_sida='".$nombre_zip_sin_consecutivo."'  ";
			$sql_vista_duplicados_reporte_obligatorio.=" ORDER BY campo_sida_de_numero_orden_8 asc,campo_sida_de_numero_orden_9 asc,  numero_secuencia asc ";
			$sql_vista_duplicados_reporte_obligatorio.=";";
			$error_bd_seq="";		
			...
			$sql_numero_de_duplicados.=" SELECT count(*) as numero_registros FROM vduplsida_".$nick_user."_".$tipo_id."_".$identificacion."  ; ";
			$error_bd_seq="";
			...
			if($numero_duplicados>0)
			{
				...
				while($contador_offset_duplicados<$numero_duplicados)
				{
					...
					$sql_query_busqueda_duplicados.="SELECT * FROM vduplsida_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite_duplicados OFFSET $contador_offset_duplicados;  ";
					$error_bd_seq="";
					$resultados_query_sida4725_duplicados=$coneccionBD->consultar_no_warning_get_error_no_crea_cierra($sql_query_busqueda_duplicados,$error_bd_seq);
					if($error_bd_seq!="")
					{
						$mensajes_error_bd.="ERROR AL CONSULTAR de vista de los duplicados: ".$error_bd_seq."<br>";
					}
					
					if(count($resultados_query_sida4725_duplicados)>0 && is_array($resultados_query_sida4725_duplicados))
					{
						foreach($resultados_query_sida4725_duplicados as $duplicado_actual)
						{
							$tipo_id_duplicado_actual=trim($duplicado_actual["campo_sida_de_numero_orden_8"]);
							$numero_id_duplicado_actual=trim($duplicado_actual["campo_sida_de_numero_orden_9"]);
							$codigo_diagnostico_actual=trim($duplicado_actual["campo_sida_de_numero_orden_17"]);
							...
							$sql_query_ya_se_proceso.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso ";
							...
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" nombre_archivo_vih_sida='".$nombre_zip_sin_consecutivo."'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_sida_de_numero_orden_8='$tipo_id_duplicado_actual'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_sida_de_numero_orden_9='$numero_id_duplicado_actual'  ";
							$sql_query_ya_se_proceso.=" ; ";
							$error_bd_seq="";
							...
							{
								if($numero_id_duplicado_actual==trim($registro_si_ya_se_proceso[0]["campo_sida_de_numero_orden_9"]))
								{
							...
							{
								$nombre_vista_duplicados_del_duplicado_actual="vduplactsida_".$nick_user."_".$tipo_id."_".$identificacion;
								...
								$sql_vista_duplicado_actual .="SELECT * from vduplsida_".$nick_user."_".$tipo_id."_".$identificacion." WHERE ";				
								...
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" nombre_archivo_vih_sida='".$nombre_zip_sin_consecutivo."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_sida_de_numero_orden_8='".$tipo_id_duplicado_actual."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_sida_de_numero_orden_9='".$numero_id_duplicado_actual."'  ";
								$sql_vista_duplicado_actual.=" ORDER BY campo_sida_de_numero_orden_8 asc,campo_sida_de_numero_orden_9 asc, numero_secuencia asc ";
								$sql_vista_duplicado_actual.=";";
								$error_bd_seq="";		
								...
								if($bool_fueron_procesados_duplicados_en_un_registro==true)
								{
									...
									$sql_insert_procesado_en_reporte_obligatorio.=" gioss_consulta_reporte_obligatorio_sida4725_exitoso ";
									$sql_insert_procesado_en_reporte_obligatorio.=" ( ";				
									$cont_orden_campo_sida=0;
									while($cont_orden_campo_sida<=184)
									{
										$sql_insert_procesado_en_reporte_obligatorio.=" campo_sida_de_numero_orden_".$cont_orden_campo_sida." , ";
										$cont_orden_campo_sida++;
									}//fin while para nombres columnas de bd correspondientes a los campos de 4725 a insertar				
									...
									while($cont_orden_campo_sida<=184)
									{
										$sql_insert_procesado_en_reporte_obligatorio.="'".alphanumericAndSpace($array_campos_procesados_de_los_duplicados_del_duplicado[$cont_orden_campo_sida])."',";
										$cont_orden_campo_sida++;
									}//fin while con los valores de los campos 4725 a insertar en la tabla de reporte obligatorio
		...
		if($mensajes_error_bd=="")
		{
			...
			$sql_insert_verificador_reportados.=" INSERT INTO gioss_archivos_obligatorios_reportados_sida ";
			$sql_insert_verificador_reportados.=" ( ";
			$sql_insert_verificador_reportados.=" usuario_que_genero, ";
			$sql_insert_verificador_reportados.=" nombre_archivo_vih_sida, ";
		...
		$sql_vista_consulta_reporte_obligatorio.="CREATE OR REPLACE VIEW vcrovih_".$nick_user."_".$tipo_id."_".$identificacion." ";
		if($estado_validacion_seleccionado=="validada")
		{
			$sql_vista_consulta_reporte_obligatorio.=" AS SELECT * FROM gioss_consulta_reporte_obligatorio_sida4725_exitoso WHERE codigo_entidad_eapb_generadora='$cod_eapb' AND nombre_archivo_vih_sida='$nombre_zip_sin_consecutivo' ORDER BY numero_secuencia asc, numero_registro asc  ; ";
		}
		else if($estado_validacion_seleccionado=="rechazada")
		{
			$sql_vista_consulta_reporte_obligatorio.=" AS SELECT * FROM gioss_consulta_reporte_obligatorio_sida4725_rechazado WHERE codigo_entidad_eapb_generadora='$cod_eapb' AND nombre_archivo_vih_sida='$nombre_zip_sin_consecutivo' ORDER BY numero_secuencia asc, numero_registro asc  ; ";
		}
		$error_bd_seq="";
		...
		$sql_numero_registros.="SELECT count(*) as contador FROM vcrovih_".$nick_user."_".$tipo_id."_".$identificacion.";  ";
		...
		while($contador_offset<$numero_registros)
		{
			...
			$sql_query_busqueda="";
			$sql_query_busqueda.="SELECT * FROM vcrovih_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite OFFSET $contador_offset;  ";
			...
			if(count($resultado_query_reporte_obligatorio)>0)
			{
				...
				*/
				...
				foreach($resultado_query_reporte_obligatorio as $resultado)
				{
					...
					while($cont_orden_campo_vih<=184)
					{
						...
						if($cont_orden_campo_vih!=0)
						{
							$cadena_escribir_linea.=alphanumericAndSpace($resultado["campo_sida_de_numero_orden_".$cont_orden_campo_vih]);
						}
		...
		//borrando vistas
		$sql_borrar_vistas="";
		$sql_borrar_vistas.=" DROP VIEW vsrovih_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		$sql_borrar_vistas.=" DROP VIEW vcrovih_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		...
		*/
		...
		if(count($array_rutas_archivos_generados)>0 && $numero_registros>0)
		{
			...
			$mensaje.="<br>Se genero el consolidado de los archivos VIH 4725 de forma comprimida.";
			if(connection_aborted()==false)
			{
		    ...
		    $mail->FromName = "GIOSS";
		    $mail->Subject = "Reporte Obligatorio VIH-SIDA 4725 ";
	...
	else
	{
		...
		else if($esta_validando_actualmente==true)
		{
			...
			{
				echo "<script>document.getElementById('div_mensaje_error').style.display='inline';</script>";
				echo "<script>document.getElementById('parrafo_mensaje_error').innerHTML='Ya hay un archivo obligatorio para 4725 que esta siendo consolidado actualmente, por favor cancele la ejecucion del anterior o espere a que termine. ';</script>";
			}
		}
	}
