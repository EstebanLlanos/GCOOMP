...
$smarty->display('conseapb2463.html.tpl');
...
{	
	...
	if($_POST["tipo_busqueda"]=="1" && isset($_POST["dpto"]) && $_POST["dpto"]!="none")
	{
		...
		$sql_numero_registros.="SELECT count(*) as contador FROM gioss_tabla_estado_informacion_r2463_erc WHERE codigo_eapb='$cod_eapb' AND ";
		...
		$sql_vista_estado_informacion.="CREATE OR REPLACE VIEW veinf2463_".$nick_user."_".$tipo_id."_".$identificacion." ";
		$sql_vista_estado_informacion.=" AS SELECT * FROM gioss_tabla_estado_informacion_r2463_erc WHERE  codigo_eapb='$cod_eapb' AND ";
		...
		while($contador_offset<$numero_registros)
		{
			...
			$sql_query_busqueda="";
			$sql_query_busqueda.="SELECT * FROM veinf2463_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite OFFSET $contador_offset;  ";
			$resultado_query_inconsistencias=$coneccionBD->consultar2($sql_query_busqueda);
		
			if(count($resultado_query_inconsistencias)>0)
			{
				
				$nombre_archivo_estado_informacion=$cod_eapb."_estado_info_2463.csv";
		...
		if($hubo_resultados)
		{
			//borrando vistas	
			$sql_borrar_vistas="";
			$sql_borrar_vistas.=" DROP VIEW veinf2463_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
			$error_bd="";		
			...
			$boton_descarga=" <input type=\'button\' value=\'Descargar archivo con el estado informacion para ERC 2463\'  class=\'btn btn-success color_boton\' onclick=\"download_archivo(\'$ruta_archivo_estado_informacion\');\"/> ";
	...
	if($_POST["tipo_busqueda"]=="2" && isset($_POST["prestador"]) )
	{
		...
		$sql_numero_registros="";
		$sql_numero_registros.="SELECT count(*) as contador FROM gioss_tabla_estado_informacion_r2463_erc WHERE codigo_eapb='$cod_eapb'  ";
		...
		$sql_vista_estado_informacion="";
		$sql_vista_estado_informacion.="CREATE OR REPLACE VIEW veinf2463_".$nick_user."_".$tipo_id."_".$identificacion." ";
		$sql_vista_estado_informacion.=" AS SELECT * FROM gioss_tabla_estado_informacion_r2463_erc WHERE codigo_eapb='$cod_eapb'  ";
		if($prestador!="none")
		{
			$sql_vista_estado_informacion.=" AND ";
