						...
						&$coneccionBD)
{
	...
	if(isset($campos[$numero_campo]))
	{
	    $campo_n11=$campos[11];
	    //campo obligatorio
	    if(trim($campos[$numero_campo])=="" && $campo_n11=="M")
	    {
		$campos[$numero_campo]="3";
	    }//fin if
	    else if(trim($campos[$numero_campo])=="" && $campo_n11=="F")
	    {
		$campos[$numero_campo]="0";
	    }//fin if 
	...
	{
	    //campo obligatorio
	    if($campos[$numero_campo]=="" && $edad_meses>18)
	    {
		$campos[$numero_campo]="0";
	    }
						...
						&$coneccionBD)
{
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    if($campos[$numero_campo]!="1" && $campos[$numero_campo]!="2" && $campos[$numero_campo]!="4")
	    {
		$campos[$numero_campo]="4";
	    }
	}//if si existe campo
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if(trim($campos[$numero_campo])!="0"
	       && trim($campos[$numero_campo])!="1"
	       && trim($campos[$numero_campo])!="2"
	       && trim($campos[$numero_campo])!="3"
		    && $campo_n11=="F")
	...
	if(isset($campos[$numero_campo]))
	{
		...
		/*
		if($edad_meses<18 && $campos[$numero_campo]!="0" && $campos[$numero_campo]!="1")
		{
		    $campos[$numero_campo]="1";
		}
		else if($edad_meses>=18 && $campos[$numero_campo]!="0" && $campos[$numero_campo]!="1")
		{
		    $campos[$numero_campo]="0";
		}
		*/
	...
	if(isset($campos[$numero_campo]))
	{
		...
		else if(checkdate(intval($array_fecha[1]),intval($array_fecha[2]),intval($array_fecha[0])))
		{
		    //correccion formato fecha al formato AAAA-MM-DD year-month-day 1800-01-01
		    $campos[$numero_campo]=corrector_formato_fecha($campos[$numero_campo],$fecha_de_corte,false,-1);
		}
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>10000)
		   && intval($campos[$numero_campo])!=99001
		   && intval($campos[$numero_campo])!=99002
		   && intval($campos[$numero_campo])!=99003
		   && intval($campos[$numero_campo])!=99004
	...
	if(isset($campos[$numero_campo]))
	{
		...
		else if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>50000)
		   && intval($campos[$numero_campo])!=99001
		   && intval($campos[$numero_campo])!=99002
		   && intval($campos[$numero_campo])!=99003
		   && intval($campos[$numero_campo])!=99004
	...
	if(isset($campos[$numero_campo]))
	{
		...
		{
		    //correccion formato fecha al formato AAAA-MM-DD year-month-day 1788-01-01
		    $campos[$numero_campo]=corrector_formato_fecha($campos[$numero_campo],$fecha_de_corte,false,-3);
		}
		else
		{
		    //correccion formato fecha al formato AAAA-MM-DD year-month-day 1800-01-01
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>50)
		   && intval($campos[$numero_campo])!=97
		   && intval($campos[$numero_campo])!=98
		   && intval($campos[$numero_campo])!=99
		    && $campo_n30=="1788-01-01")
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>20)
		   && intval($campos[$numero_campo])!=99
		    && ($campo_n30!="1800-01-01")
		    &&  $campo_n50=="2"
		    )
	...
	if(isset($campos[$numero_campo]))
	{
		//la correccion de valor permitido se hara en la de campo obligatorio
		//debido a que el campo 56 depnde de este desde dicha fase
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>5000)
		   && intval($campos[$numero_campo])!=88888
		   && intval($campos[$numero_campo])!=99999
		    && $campo_ant_20=="0"
		    && $campo_ant_77=="1800-01-01"
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    if(count($array_fecha)!=3 || !checkdate(intval($array_fecha[1]),intval($array_fecha[2]),intval($array_fecha[0])))
	    {
		if(($campo_n17=="0" || $campo_n17=="3"))
		{
		    //correccion formato fecha al formato AAAA-MM-DD year-month-day 1799-01-01
		    $campos[$numero_campo]=corrector_formato_fecha($campos[$numero_campo],$fecha_de_corte,false,-2);
		}
		else if(($campo_n17!="0" && $campo_n17!="3"))
		{
		    //correccion formato fecha al formato AAAA-MM-DD year-month-day 1800-01-01
		    $campos[$numero_campo]=corrector_formato_fecha($campos[$numero_campo],$fecha_de_corte,false,-1);
		}
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    $campo_n106=trim($campos[183]);
	    if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>16)
	       && $campo_n106=="1799-01-01"
	       )
	    {
		$campos[$numero_campo]="0";
	    }	
	    else if((intval($campos[$numero_campo])<0 || intval($campos[$numero_campo])>16))
	    {
		$campos[$numero_campo]="0";
	    }//fin if
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    if($fix_ultimo_campo=="")
	    {
		    ...
		    //consecutivo|nombre|codigo_tipo_inconsistencia|desc_tipo_inconsistencia|codigo_grupo_inconsistencia|desc_tipo_inconsistencia|codigo_detalle_inconsistencia|desc_detalle|linea|campo
		    $cadena_descripcion_inconsistencia=explode(";;",$array_detalle_validacion["0104001"])[1];
		    $errores_campos.=$consecutivo_errores.",".$nombre_archivo_registrado.",01,".$array_tipo_validacion["01"].",0104,".$array_grupo_validacion["0104"].",0104001,$cadena_descripcion_inconsistencia ...".$fix_ultimo_campo." ,".($nlinea+1).",".$array_numero_campo_bd[$numero_campo];
		    $consecutivo_errores++;
	    ...
	    if(trim($fix_ultimo_campo)!="1"
		   ...
		   && $campo_ant_106=="1799-01-01"
		   )
	    {
		$campos[$numero_campo]="0";
	    }
	    else if(trim($fix_ultimo_campo)!="1"
		   && trim($fix_ultimo_campo)!="2"
		   && trim($fix_ultimo_campo)!="3"
		   &&trim($fix_ultimo_campo)!="0"
		   )
