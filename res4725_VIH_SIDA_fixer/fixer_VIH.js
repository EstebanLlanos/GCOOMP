...
function verificar_nombre_archivo(path_val,sigla,div_nombre)
{
	...
	if (fullPath) 
	{
		...
		{
		    if (nombre_sin_extension[0].length!=32 && nombre_sin_extension[0].length!=19)
		    {
			mensaje+="ERROR: La longitud del archivo de "+nombre_sin_extension[0].length+" caracteres no corresponde a 32 o 19 caracteres para agrupado <br>";
		    }
		...
		{			
			...
			else if (document.getElementById("tipo_archivo_norma").value=="agrupado_eapb")
			{
			    ...
			    else if (nombre_sin_extension[0].length==19)
			    {
...
function validar_campos()
{
	...
	{
		mensaje+='<br>-Registre el nombre del archivo \n';
	}
	...
	//verificacion de la carga del archivo vih
    if(document.getElementById("r4725_file").value=="")
	{
		mensaje+='<br>-Seleccione un archivo VIH a validar \n';
	}
	
	
	if(document.getElementById("SIDA_hidden").value=="error")
	{
		mensaje+='<br>-EL archivo seleccionado para VIH no tiene un nombre valido \n';
	}
	
	//fin verificacion de la carga del archivo vih
...
{
	if(document.getElementById('r4725_file'))
	{
		reset_file_elem(document.getElementById('r4725_file'));
		verificar_nombre_archivo(document.getElementById('r4725_file').value,'VIH','nombre_archivo_r4725');
	}
