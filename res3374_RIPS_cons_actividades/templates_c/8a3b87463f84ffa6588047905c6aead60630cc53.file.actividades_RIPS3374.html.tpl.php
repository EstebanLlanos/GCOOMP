<?php /* Smarty version Smarty-3.1.17, created on 2014-10-01 09:34:58
         compiled from "actividades_RIPS3374.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2517542b31a6cbc7d9-61675205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8a3b87463f84ffa6588047905c6aead60630cc53' => 
    array (
      0 => 'actividades_RIPS3374.html.tpl',
      1 => 1412159028,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2517542b31a6cbc7d9-61675205',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_542b31a722d6f9_19439616',
  'variables' => 
  array (
    'menu' => 1,
    'nombre' => 1,
    ...
    'campo_mpio' => 1,
    'campo_prestador' => 1,
    'campo_grupo_procedimiento' => 1,
    'campo_grupo_sistemas' => 1,
    'mensaje_proceso' => 1,
    'mostrarResultado' => 1,
  ),
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542b31a722d6f9_19439616')) {function content_542b31a722d6f9_19439616($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">       
        <script type="text/javascript" src="../librerias_externas/jquery_min/jquery-1.10.2.js"> </script>       
        <script type="text/javascript" src="actividades_RIPS3374.js"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="actividades_RIPS3374.css" rel="stylesheet" />
       <title>Actividades De Procedimientos</title>
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario"  method="post">
						...
						<h5 style="color:blue;">ESCTRUCTURA DE ACTIVIDADES DE PROCEDIMIENTO POR EDAD Y SEXO RIPS(EAPB):</h5>
						<br>
						&#32
						</td>
						</tr>
 ...
 <div id='mostrar_mpio' style='display:inline;'><?php echo $_smarty_tpl->tpl_vars['campo_mpio']->value;?>
						...
						<tr>
						<td style="text-align:left;">
						<input type="radio" name="criterio_busqueda" id="por_grupo_procedimiento" value="cb_1_grupo_procedimiento" onclick="mostrar_grupo_procedimiento_o_sistema();"/>Por Grupo de Procedimiento.
						</td>
						</tr>
						<tr>
						<td style="text-align:left;">
						<input type="radio" name="criterio_busqueda" id="por_grupo_sistema" value="cb_2_grupo_sistema" onclick="mostrar_grupo_procedimiento_o_sistema();"/>Por Tipo de Sistema.						
						</td>
						</tr>
						
						<!--GRUPO PROCEDIMIENTO-->
						<tr id='tr_titulo_grupo_procedimiento' style="display: none">
						<td style="text-align:left;">
						<b>Grupo Procedimiento:</b>
						</td>
						</tr>
						
						<tr id='tr_selector_procedimiento' style="display: none">
						<td style="text-align:left;">
						<?php echo $_smarty_tpl->tpl_vars['campo_grupo_procedimiento']->value;?>

						</td>
						</tr>
						
						<!--GRUPO SISTEMA-->
						<tr id='tr_titulo_grupo_sistema' style="display: none">
						<td  style="text-align:left;">
						<b>Tipo de Sistema:</b>
						</td>
						</tr>
						
						<tr id='tr_selector_grupo_sistema' style="display: none">
						<td style="text-align:left;">
						<?php echo $_smarty_tpl->tpl_vars['campo_grupo_sistemas']->value;?>
						...
						<td style="text-align:left;">
							...
							<div id='div_mensaje_exito' class="sec2" style="width:90%;display:none;">
								...
								<div class="alert-success alert-block alert-success fade in">
									...
									<h4 id='titulo_mensaje_exito' class="alert-heading" style="text-align: center">&iexclConsulta Completada!</h4>
