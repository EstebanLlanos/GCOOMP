...
if(isset($_POST["year_de_corte"]) && isset($_POST['eapb']) && $_POST['eapb']!="none" && $_POST["year_de_corte"]!="" && ctype_digit($_POST["year_de_corte"]) )
{
	...
	if(count($resultado_verificar_es_administrador)>0 && $esta_validando_actualmente==false)
	{
		...
		if(isset($array_permisos[0]))
		{
			if($array_permisos[0]=="SI")
			{
				...
				{
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_cancer0247_rechazado ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_cancer='$nombre_archivo_para_zip' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
	...
	if($ya_se_reporto_archivo==false)
	{
		...
		$sql_datos_reporte_obligatorio.="CREATE OR REPLACE VIEW vsroc_".$nick_user."_".$tipo_id."_".$identificacion." ";
		...
		else if($accion=="rechazada")
		{
			...
			$sql_datos_reporte_obligatorio .=" (fecha_corte   BETWEEN '".$fecha_ini_bd."'  AND '".$fecha_fin_bd."' )  ";
			$sql_datos_reporte_obligatorio .=" AND ";
			$sql_datos_reporte_obligatorio .=" codigo_eapb_a_reportar='".$cod_eapb."' ORDER BY numero_secuencia asc,fila asc ";
		}
		...
		$sql_query_numero_registros.="SELECT count(*) as contador FROM vsroc_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		...
		while($contador_offset<$numero_registros)
		{
			...
			$sql_query_busqueda="";
			$sql_query_busqueda.="SELECT * FROM vsroc_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite OFFSET $contador_offset;  ";
			$resultados_query_cancer=$coneccionBD->consultar2_no_crea_cierra($sql_query_busqueda);
			foreach($resultados_query_cancer as $linea_consulta)
			{
				//PARTE ACOMODACION DEL REGIMEN
				$regimen_afiliacion=$linea_consulta["campo_cancer_de_numero_orden_8"];
				...
				//ELIMINA SI EXISTE UN REGISTRO CON EL MISMO AFILIADO PREVIO CON UN NUMERO DE SECUENCIA MENOR
				...
				if($accion=="validada")
				{
					...
					$sql_hubo_en_duplicados.=" gioss_consulta_reporte_obligatorio_cancer0247_exitoso_duplicado ";
					...
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" nombre_archivo_cancer='".$nombre_archivo_para_zip."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_cancer_de_numero_orden_5='".trim($linea_consulta["campo_cancer_de_numero_orden_5"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_cancer_de_numero_orden_6='".trim($linea_consulta["campo_cancer_de_numero_orden_6"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_cancer_de_numero_orden_17='".trim($linea_consulta["campo_cancer_de_numero_orden_17"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" ( ";
					...
					if(count($registros_desde_tabla_duplicados)>0 && is_array($registros_desde_tabla_duplicados))
					{
						...
						$sql_insert_duplicados_rep_oblig_cancer="";
						$sql_insert_duplicados_rep_oblig_cancer.=" INSERT INTO ";
						$sql_insert_duplicados_rep_oblig_cancer.=" gioss_consulta_reporte_obligatorio_cancer0247_exitoso_duplicado ";				
						$sql_insert_duplicados_rep_oblig_cancer.=" ( ";				
						$cont_orden_campo_cancer=1;
						while($cont_orden_campo_cancer<=210)
						{
							$sql_insert_duplicados_rep_oblig_cancer.=" campo_cancer_de_numero_orden_".$cont_orden_campo_cancer." , ";
							$cont_orden_campo_cancer++;
						}//fin while para nombres columnas de bd correspondientes a los campos de 0247 a insertar				
						$sql_insert_duplicados_rep_oblig_cancer.=" numero_secuencia, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" numero_registro, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" regimen, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" fecha_corte_reporte, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" fecha_de_generacion, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" hora_generacion, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" codigo_entidad_eapb_generadora, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" codigo_entidad_prestadora, ";
						$sql_insert_duplicados_rep_oblig_cancer.=" nombre_archivo_cancer ";
						$sql_insert_duplicados_rep_oblig_cancer.=" ) ";
						$sql_insert_duplicados_rep_oblig_cancer.=" VALUES ";
						$sql_insert_duplicados_rep_oblig_cancer.=" ( ";				
						$cont_orden_campo_cancer=1;
						while($cont_orden_campo_cancer<=210)
						{
							$sql_insert_duplicados_rep_oblig_cancer.="'".alphanumericAndSpace($linea_consulta["campo_cancer_de_numero_orden_".$cont_orden_campo_cancer])."',";
							$cont_orden_campo_cancer++;
						}//fin while con los valores de los campos 0247 a insertar en la tabla de reporte obligatorio
						$sql_insert_duplicados_rep_oblig_cancer.="'".$linea_consulta["numero_secuencia"]."',";
						$sql_insert_duplicados_rep_oblig_cancer.="'".$linea_consulta["fila"]."',";				
						$sql_insert_duplicados_rep_oblig_cancer.="'".$regimen_almacenado."',";								
						$sql_insert_duplicados_rep_oblig_cancer.="'".$fecha_corte_bd."',";
						$sql_insert_duplicados_rep_oblig_cancer.="'".$fecha_actual."',";
						$sql_insert_duplicados_rep_oblig_cancer.="'".$tiempo_actual."',";
						$sql_insert_duplicados_rep_oblig_cancer.="'".$linea_consulta["codigo_eapb_a_reportar"]."',";
						$sql_insert_duplicados_rep_oblig_cancer.="'".$linea_consulta["codigo_prestador_reportante"]."',";
						$sql_insert_duplicados_rep_oblig_cancer.="'".$nombre_archivo_para_zip."'";
						$sql_insert_duplicados_rep_oblig_cancer.=" ) ";
						$sql_insert_duplicados_rep_oblig_cancer.=" ; ";
						$error_bd_seq="";		
						$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($sql_insert_duplicados_rep_oblig_cancer, $error_bd_seq);
						if($error_bd_seq!="")
						{
					...
					$sql_query_ultimo_dejado.=" gioss_consulta_reporte_obligatorio_cancer0247_exitoso ";
					...
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" nombre_archivo_cancer='".$nombre_archivo_para_zip."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_cancer_de_numero_orden_5='".trim($linea_consulta["campo_cancer_de_numero_orden_5"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_cancer_de_numero_orden_6='".trim($linea_consulta["campo_cancer_de_numero_orden_6"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_cancer_de_numero_orden_17='".trim($linea_consulta["campo_cancer_de_numero_orden_17"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" ( ";
					...
					if(count($registro_ultimo_dejado)>0 && is_array($registro_ultimo_dejado))
					{
						...
						foreach($registro_ultimo_dejado as $ultimo_registro)
						{
							...
							while($cont_orden_campo_cancer<=210)
							{
								$sql_insert_duplicados_rep_oblig_cancer.="'".alphanumericAndSpace($ultimo_registro["campo_cancer_de_numero_orden_".$cont_orden_campo_cancer])."',";
								$cont_orden_campo_cancer++;
							}//fin while con los valores de los campos 0247 a insertar en la tabla de reporte obligatorio
							$sql_insert_duplicados_rep_oblig_cancer.="'".$ultimo_registro["numero_secuencia"]."',";
							$sql_insert_duplicados_rep_oblig_cancer.="'".$ultimo_registro["numero_registro"]."',";	
							$sql_insert_duplicados_rep_oblig_cancer.="'".$regimen_almacenado."',";								
							$sql_insert_duplicados_rep_oblig_cancer.="'".$fecha_corte_bd."',";
							$sql_insert_duplicados_rep_oblig_cancer.="'".$fecha_actual."',";
							$sql_insert_duplicados_rep_oblig_cancer.="'".$tiempo_actual."',";
							$sql_insert_duplicados_rep_oblig_cancer.="'".$ultimo_registro["codigo_entidad_eapb_generadora"]."',";
							$sql_insert_duplicados_rep_oblig_cancer.="'".$ultimo_registro["codigo_entidad_prestadora"]."',";
							$sql_insert_duplicados_rep_oblig_cancer.="'".$nombre_archivo_para_zip."'";
							$sql_insert_duplicados_rep_oblig_cancer.=" ) ";
							$sql_insert_duplicados_rep_oblig_cancer.=" ; ";
							$error_bd_seq="";		
					...
					$sql_delete_duplicados.=" gioss_consulta_reporte_obligatorio_cancer0247_exitoso ";					
					...
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" nombre_archivo_cancer='".$nombre_archivo_para_zip."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_cancer_de_numero_orden_5='".trim($linea_consulta["campo_cancer_de_numero_orden_5"])."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_cancer_de_numero_orden_6='".trim($linea_consulta["campo_cancer_de_numero_orden_6"])."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_cancer_de_numero_orden_17='".trim($linea_consulta["campo_cancer_de_numero_orden_17"])."'  ";
					$sql_delete_duplicados.=" ; ";
					$error_bd_seq="";		
				...
				//FIN ELIMINA SI EXISTE UN REGISTRO CON EL MISMO AFILIADO PREVIO CON UN NUMERO DE SECUENCIA MENOR
				...
				if($hubo_duplicado==false)
				{
					...
					{
						$sql_insert_consulta_reporte_obligatorio.=" gioss_consulta_reporte_obligatorio_cancer0247_rechazado ";
					}
					$sql_insert_consulta_reporte_obligatorio.=" ( ";
					$cont_orden_campo_cancer=1;
					while($cont_orden_campo_cancer<=210)
					...
					while($cont_orden_campo_cancer<=210)
					{
						$sql_insert_consulta_reporte_obligatorio.="'".alphanumericAndSpace($linea_consulta["campo_cancer_de_numero_orden_".$cont_orden_campo_cancer])."',";
						$cont_orden_campo_cancer++;
					}
		...
		//FIN SUBIDA A TABLA CONSOLIDADO  CANCER 
		...
		if($accion=="validada" && $hubo_al_menos_un_duplicado==true)
		{
			...
			$sql_vista_duplicados_reporte_obligatorio.="CREATE OR REPLACE VIEW vduplcancer_".$nick_user."_".$tipo_id."_".$identificacion." ";
			$sql_vista_duplicados_reporte_obligatorio.=" AS  ";					
			$sql_vista_duplicados_reporte_obligatorio .="SELECT * from gioss_consulta_reporte_obligatorio_cancer0247_exitoso_duplicado WHERE ";				
			...
			$sql_vista_duplicados_reporte_obligatorio.=" AND ";
			$sql_vista_duplicados_reporte_obligatorio.=" nombre_archivo_cancer='".$nombre_archivo_para_zip."'  ";
			$sql_vista_duplicados_reporte_obligatorio.=" ORDER BY campo_cancer_de_numero_orden_5 asc,campo_cancer_de_numero_orden_6 asc, campo_cancer_de_numero_orden_17 asc, numero_secuencia asc ";
			$sql_vista_duplicados_reporte_obligatorio.=";";
			$error_bd_seq="";		
			...
			$sql_numero_de_duplicados.=" SELECT count(*) as numero_registros FROM vduplcancer_".$nick_user."_".$tipo_id."_".$identificacion."  ; ";
			$error_bd_seq="";
			...
			if($numero_duplicados>0)
			{
				...
				while($contador_offset_duplicados<$numero_duplicados)
				{
					...
					$sql_query_busqueda_duplicados.="SELECT * FROM vduplcancer_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite_duplicados OFFSET $contador_offset_duplicados;  ";
					$error_bd_seq="";
					$resultados_query_cancer0247_duplicados=$coneccionBD->consultar_no_warning_get_error_no_crea_cierra($sql_query_busqueda_duplicados,$error_bd_seq);
					if($error_bd_seq!="")
					{
					...
					if(count($resultados_query_cancer0247_duplicados)>0 && is_array($resultados_query_cancer0247_duplicados))
					{
						...
						{
							$tipo_id_duplicado_actual=trim($duplicado_actual["campo_cancer_de_numero_orden_5"]);
							$numero_id_duplicado_actual=trim($duplicado_actual["campo_cancer_de_numero_orden_6"]);
							$codigo_diagnostico_actual=trim($duplicado_actual["campo_cancer_de_numero_orden_17"]);
							...
							$sql_query_ya_se_proceso.=" gioss_consulta_reporte_obligatorio_cancer0247_exitoso ";
							...
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" nombre_archivo_cancer='".$nombre_archivo_para_zip."'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_cancer_de_numero_orden_5='$tipo_id_duplicado_actual'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_cancer_de_numero_orden_6='$numero_id_duplicado_actual'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_cancer_de_numero_orden_17='$codigo_diagnostico_actual'  ";
							$sql_query_ya_se_proceso.=" ; ";
							$error_bd_seq="";
							...
							{
								if($numero_id_duplicado_actual==trim($registro_si_ya_se_proceso[0]["campo_cancer_de_numero_orden_6"]))
								{
							...
							{
								$nombre_vista_duplicados_del_duplicado_actual="vduplactcancer_".$nick_user."_".$tipo_id."_".$identificacion;
								...
								$sql_vista_duplicado_actual .="SELECT * from vduplcancer_".$nick_user."_".$tipo_id."_".$identificacion." WHERE ";				
								...
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" nombre_archivo_cancer='".$nombre_archivo_para_zip."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_cancer_de_numero_orden_5='".$tipo_id_duplicado_actual."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_cancer_de_numero_orden_6='".$numero_id_duplicado_actual."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_cancer_de_numero_orden_17='".$codigo_diagnostico_actual."'  ";
								$sql_vista_duplicado_actual.=" ORDER BY campo_cancer_de_numero_orden_5 asc,campo_cancer_de_numero_orden_6 asc,campo_cancer_de_numero_orden_17 asc, numero_secuencia asc ";
								$sql_vista_duplicado_actual.=";";
								$error_bd_seq="";		
								...
								if($bool_fueron_procesados_duplicados_en_un_registro==true)
								{
									...
									while($cont_orden_campo_cancer<210)
									{
										$sql_insert_procesado_en_reporte_obligatorio.="'".alphanumericAndSpace($array_campos_procesados_de_los_duplicados_del_duplicado[$cont_orden_campo_cancer])."',";
										$cont_orden_campo_cancer++;
									}//fin while con los valores de los campos 0247 a insertar en la tabla de reporte obligatorio
		...
		//borrando vistas
		$sql_borrar_vistas="";
		$sql_borrar_vistas.=" DROP VIEW vsroc_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		...
		*/
		...
		if(count($array_rutas_archivos_generados)>0 && $numero_registros>0)
		{
			...
			$mensaje.="<br>Se genero el consolidado de los archivos 0247 de forma comprimida.";
			if(connection_aborted()==false)
			{
