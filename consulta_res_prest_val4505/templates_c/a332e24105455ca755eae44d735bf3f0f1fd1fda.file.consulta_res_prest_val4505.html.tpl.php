<?php /* Smarty version Smarty-3.1.17, created on 2017-08-31 09:58:23
         compiled from "consulta_res_prest_val4505.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3077559a82097dc32a8-76161622%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a332e24105455ca755eae44d735bf3f0f1fd1fda' => 
    array (
      0 => 'consulta_res_prest_val4505.html.tpl',
      1 => 1504191500,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3077559a82097dc32a8-76161622',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_59a82097e13c94_03295988',
  'variables' => 
  array (
    'menu' => 1,
    'nombre' => 1,
...
<?php if ($_valid && !is_callable('content_59a82097e13c94_03295988')) {function content_59a82097e13c94_03295988($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="consulta_res_prest_val4505.js?v=1.595"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="consulta_res_prest_val4505.css?v=1.0" rel="stylesheet" />
       <title>Consulta Resultados Prestadores 4505</title>
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post" enctype= "multipart/form-data">
					    ...
					    <tr>
							<td style="text-align:left;">
								<h5 id='sub_titulo_1' style="color:#0000FF;text-shadow: 2px 2px 5px #A8A8FF;">Consulta Resultados Prestadores Validaci&oacute;n:</h5>
							</td>
						</tr>
						...
						<tr>
							<td style="text-align:left;">
								<select id='selector_rango_conteo' name='selector_rango_conteo' class='campo_azul' onchange='mostrar_opciones_correspondientes_al_caso()' >
									...
									<option value='res_allips' >Reporte resultados todas IPS del archivo</option>	
									<option value='res_oneips' >Reporte resultados IPS especifica del archivo</option>	
