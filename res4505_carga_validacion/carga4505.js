...
$(function() 
{
    ...
    $("#nombre_archivo_pyp_copy").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Este campo corresponde al nombre del archivo<br>'});
...
function cargar4505()
{
	...
	{
		ventana_resumen_carga();
	}
}

function empezar_validacion()
{
	document.getElementById('boton_continuar_modal').innerHTML= 'Espere Mientras Se Hace Upload Del Archivo Para Validar';
...
//FUNCIONES SUBIR TABLAS RIESGO POBLACION

var global_rp_cod_prestador_servicios_salud="";
var global_rp_codigo_eapb="";
var global_rp_numero_de_identificacion_de_la_entidad_reportadora="";
var global_rp_numero_de_secuencia="";
var global_rp_fecha_de_corte="";
var global_rp_tipo_de_identificacion_entidad_reportadora="";
var global_rp_tipo_de_regimen_de_la_informacion_reportada="";
var global_rp_fecha_validacion="";
var global_rp_hora_validacion="";
var global_rp_nombre_archivo="";


function mostrar_ventana_tablas_riesgo_poblacion(cod_prestador_servicios_salud,
						 codigo_eapb,
						 numero_de_identificacion_de_la_entidad_reportadora,
						 numero_de_secuencia,
						 fecha_de_corte,
...
{
    global_rp_cod_prestador_servicios_salud=cod_prestador_servicios_salud;
    global_rp_codigo_eapb=codigo_eapb;
    global_rp_numero_de_identificacion_de_la_entidad_reportadora=numero_de_identificacion_de_la_entidad_reportadora;
    global_rp_numero_de_secuencia=numero_de_secuencia;
    global_rp_fecha_de_corte=fecha_de_corte;
    global_rp_tipo_de_identificacion_entidad_reportadora=tipo_de_identificacion_entidad_reportadora;
    global_rp_tipo_de_regimen_de_la_informacion_reportada=tipo_de_regimen_de_la_informacion_reportada;
    global_rp_fecha_validacion=fecha_validacion;
    global_rp_hora_validacion=hora_validacion;
    global_rp_nombre_archivo=nombre_archivo;
    
    var mensaje="";
    mensaje+="Desea subir a las tablas de poblaci&oacuten riesgo con la informaci&oacuten valida proveida por el archivo:<br>";
    mensaje+="Prestador: "+cod_prestador_servicios_salud+"<br>"+
	    "EAPB: "+codigo_eapb+"<br>"+
	    "NIT: "+numero_de_identificacion_de_la_entidad_reportadora+"<br>"+
	    "Numero Secuencia Validaci&oacuten: "+numero_de_secuencia+"<br>"+
	    "Fecha de corte: "+fecha_de_corte+"<br>"+
	    "Tipo id entidad reportadora: "+tipo_de_identificacion_entidad_reportadora+"<br>"+
	    "Tipo Regimen: "+tipo_de_regimen_de_la_informacion_reportada+"<br>"+
	    "Fecha validaci&oacuten: "+fecha_validacion+"<br>"+
	    "Hora validaci&oacuten: "+hora_validacion+"<br>"+
	    "<b>NOMBRE ARCHIVO</b>: "+nombre_archivo;
    
    $("h3#tituloVentana_riesgo_poblacion").html("SUBIR A TABLAS RIESGO POBLACI&OacuteN");
    $("div#mensajeVentana_riesgo_poblacion").html("<p>" + mensaje + "</p>");
    $('#myModal_riesgo_poblacion').modal({backdrop: "static"});
    
}
var estado_subida;
function subir_tablas_riesgo_poblacion()
{
    document.getElementById("cerrar_subir_poblacion").disabled= true;
    document.getElementById("cerrar_subir_poblacion_x").disabled= true;
    document.getElementById("boton_subir_riesgo_poblacion").disabled= true;
    
    /*
    alert("subiendo "+
	    global_rp_cod_prestador_servicios_salud+
	    global_rp_codigo_eapb+
	    global_rp_numero_de_identificacion_de_la_entidad_reportadora+
	    global_rp_numero_de_secuencia+
	    global_rp_fecha_de_corte+
	    global_rp_tipo_de_identificacion_entidad_reportadora+
	    global_rp_tipo_de_regimen_de_la_informacion_reportada+
	    global_rp_fecha_validacion+
	    global_rp_hora_validacion+
	    global_rp_nombre_archivo
	  );
    
    */
    
    ConsultaAJAX_Async("c1="+global_rp_cod_prestador_servicios_salud+
		       "&c2="+global_rp_codigo_eapb+
		       "&c3="+global_rp_numero_de_identificacion_de_la_entidad_reportadora+
		       "&c4="+global_rp_numero_de_secuencia+
		       "&c5="+global_rp_fecha_de_corte+
		       "&c6="+global_rp_tipo_de_identificacion_entidad_reportadora+
		       "&c7="+global_rp_tipo_de_regimen_de_la_informacion_reportada+
		       "&c8="+global_rp_fecha_validacion+
		       "&c9="+global_rp_hora_validacion+
		       "&c10="+global_rp_nombre_archivo
		       ,
		       "subir_riesgo_poblacion.php",
		       "none");
    
    $("div#mensajeVentana_riesgo_poblacion").html("<span style='color:red;text-align:center;'><b>INICIANDO</b></span>");
    
    estado_subida=setInterval(function(){consultar_estado_subida()},2500);
}

function consultar_estado_subida()
{
    ConsultaAJAX_Async("c1="+global_rp_cod_prestador_servicios_salud+
		       "&c2="+global_rp_codigo_eapb+
		       "&c3="+global_rp_numero_de_identificacion_de_la_entidad_reportadora+
		       ...
		       "&c10="+global_rp_nombre_archivo
		       ,
		       "consulta_estado_subida_rp.php",
		       "mensajeVentana_riesgo_poblacion");
    
    if (document.getElementById('estado_subida_hidden'))
    {
	if (document.getElementById('estado_subida_hidden').value=="TERMINADO")
	{
	    clearInterval(estado_subida);
	    document.getElementById("cerrar_subir_poblacion").disabled= false;
	    document.getElementById("cerrar_subir_poblacion_x").disabled= false;
	}
    }
}
//FIN FUNCIONES SUBIR TABLAS RIESGO POBLACION

function ventana_resumen_carga()
{
	var tipo_entidad_seleccionada=document.getElementById("tipo_archivo_4505").value;
	var tipo_entidad_bd=document.getElementById("tipo_entidad_asociada_hidden").value;
	...
	var nombre_archivo=document.getElementById("nombre_archivo_pyp_copy").value;
	
	var dpto=document.getElementById("dpto").value;
	var mpio=document.getElementById("mpio").value;
	
	var mensaje="";
	mensaje+="Nombre del Archivo a Cargar: "+nombre_archivo+".<br>";
	...
	else if (tipo_entidad_seleccionada=="ent_territoriales")
	{
		mensaje+="Tipo Entidad que reportara: Entidad Territorial (Archivo agrupado, para filtro geografico).<br>";
		mensaje+="Entidad que reportara: "+entidad_1+".<br>";
		mensaje+="Entidad a la cual se realizara el cargue: "+entidad_2+".<br>";
		mensaje+="Departamento: "+dpto+".<br>";
		mensaje+="Municipio: "+mpio+".<br>";
	}
	else if (tipo_entidad_seleccionada=="agrupado_eapb")
	{
		...
		mensaje+="Entidad que validara agrupado: "+entidad_2+".<br>";
	}
	mensaje+="Tipo Rango de tiempo a cargar: "+tipo_periodo_tiempo+".<br>";
...
function validarCampos() 
{
    ...
    if ($("#nombre_archivo_pyp_copy").val() == "")
        mensaje += '<br>-El nombre del archivo es obligatorio\n';
    ...
    if ($("#tipo_archivo_4505").val() == "ent_territoriales")
    {
	if ($("#dpto").val() == "none")
	{
	    mensaje += '<br>-Debe seleccionar all menos el departamento como filtro geografico\n';
	}
    }
    ...
    else 
	{
        ...
        $("div#mensajeVentana").html("<p>" + mensaje + "</p>");
        $('#myModal').modal('toggle');
	document.getElementById('boton_continuar_modal').style.display="none";
...
function obtener_nombre_file_upload()
{
	...
	if (fullPath) 
	{
		...
		document.getElementById('nombre_archivo_pyp_copy').value=filename;
		ajustar_text_tag_al_texto('nombre_archivo_pyp_copy');
	}
	else
	{
		document.getElementById('nombre_archivo').innerHTML="no se ha subido un archivo";
		document.getElementById('nombre_archivo_pyp_copy').value="";
		ajustar_text_tag_al_texto('nombre_archivo_pyp_copy');
	}
}

function ajustar_text_tag_al_texto(nombre_text_tag)
{
	var longitud_un_caracter_en_px=8;
	
	var numero_caracteres_minimos=10;
	
	var longitud_actual_caracteres_en_el_tag=document.getElementById(nombre_text_tag).value.length;
	
	if (longitud_actual_caracteres_en_el_tag>numero_caracteres_minimos)
	{
		document.getElementById(nombre_text_tag).style.width=(longitud_actual_caracteres_en_el_tag*longitud_un_caracter_en_px)+"px";
	}
	else
	{
		document.getElementById(nombre_text_tag).style.width="206px";
	}
}
...
function acomodar_tipo_periodo_tiempo(valor_selector)
{
	...
	if (valor_selector_tipo_periodo=="trimestral")
	{
		...
		fecha_remision_html="";
		fecha_remision_html+="<input style='width:215px;' type='text' name='fecha_remision' id='fecha_remision' placeholder='clic aqui para seleccionar una fecha' class='campo_azul' onchange='funciones_fecha_restriciones_trimestral(this);validar_antes_seleccionar_archivos();'/>";
	...
	else if(valor_selector_tipo_periodo=="mensual")
	{
		...
		fecha_remision_html="";
		fecha_remision_html+="<input style='width:215px;' type='text' name='fecha_remision' id='fecha_remision' placeholder='clic aqui para seleccionar una fecha' class='campo_azul' onchange='funciones_fecha_restriciones(this);validar_antes_seleccionar_archivos();'/>";
		document.getElementById("div_fecha_remision").innerHTML=fecha_remision_html;
...
function verificar_nombre_archivo(path_val,sigla,div_nombre)
{
	...
	if (fullPath) 
	{
		...
		//regimen pos 32 longitud 33
		//consecutivo pos 33 longitud 35
