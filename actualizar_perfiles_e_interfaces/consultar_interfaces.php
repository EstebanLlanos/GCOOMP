...
function recorrer_arbol_y_dibujar_gestion(array $arbol_menu,$raiz,$perfil_id,&$coneccionBD)
{
	...
	while($cont<count($arbol_menu))
	{
		...
		*/
		...
		$html.="</td><td>";	
		$html.="<b><div id='div_prio".$menu_actual["id_principal"]."'><input type='text' style='width:30px;' class='campo_azul' id='valor_prio_".$menu_actual["id_principal"]."' name='valor_prio_".$menu_actual["id_principal"]."' value='".$menu_actual["prioridad_jerarquica"]."' onkeypress=\"reset_div('res_prio".$menu_actual["id_principal"]."');return isNumberKey(event)\" onchange=\"reset_div('res_prio".$menu_actual["id_principal"]."');\" /></div><div id='res_prio".$menu_actual["id_principal"]."'></div></b>";
		$html.="</td><td><input type='button' class='btn btn-success color_boton' id='cambiar_prioridad".$menu_actual["id_principal"]."' name='cambiar_prioridad".$menu_actual["id_principal"]."' value='OK' onclick=\"cambiar_prioridad_bd('".$menu_actual["id_principal"]."','".$menu_actual["id_padre"]."');\" ></td></tr></table>";	
