...
<html>
    <head>
        ...
        <script type="text/javascript" src="conversor_excel_plano0247.js"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="conversor_excel_plano0247.css" rel="stylesheet" />
       <title>conversor_excel_plano0247</title>
						...
						<table>
							...
							<tr>
							    <td style="text-align:left;">
							    	<h4 style="color:#0000FF;text-shadow: 2px 2px 5px #A8A8FF;">Conversor Excel A Plano para 0247</h4>
							    </td>
					    	</tr>

						<tr>
							<td style="text-align:left;">
								<h5 id='sub_titulo_1' style="color:#0000FF;text-shadow: 2px 2px 5px #A8A8FF;">Seleccione los archivos en excel (xlsx) que tengan en su enterior 210 columnas coincidiendo con la estructura requerida por la norma de promocion y prevencion (Cancer 0247) para convertirlos en archivos planos usando el delimitador de tabulaci&aocute;n requerido para la norma ( \t ):</h5>
							</td>
						</tr>
