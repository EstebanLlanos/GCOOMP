...
$smarty->display('conversor_excel_plano0247.html.tpl');
...
//usuario normal ips
/*
INSERT INTO gios_menus_opciones_sistema(id_principal,id_padre,nombre_opcion,descripcion_ayuda,tiene_submenus,ruta_interfaz,prioridad_jerarquica) VALUES ('228','13','Excel Plano 0247','',FALSE,'..|conversor_excel_plano0247|conversor_excel_plano0247.php','33.05');
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('228','5'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('228','4'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('228','3');
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('228','2'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('228','1'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('228','13'); 
*/
...
$nombre_carpeta_origen="origcv0247".$fecha_para_archivo;
$nombre_carpeta_destino="destcv0247".$fecha_para_archivo;
	    	...
	    	if($es_excel_archivo_actual==false)
	    	{
				...
				if ($lectorArchivo) 
				{
				    ...
				    while (($buffer = fgets($lectorArchivo, 9999)) !== false) 
				    {
				    	...
				    	$cumplio_con_210_campos=false;
				    	$linea_resultado="";
				    	if(count($array_campos_por_tubo)==210 )
				    	{
				    		$cont=0;
				    		...
				    		$cumplio_con_210_campos=true;
				    		$se_arreglo_linea=true;
				    	}//fin if
				    	else if(count($array_campos_por_punto_y_coma)==210)
				    	{
				    		$cont=0;
				    	...
				    	else if(count($array_campos_por_tabulacion)==210)
				    	{
				    		$cont=0;
				    	...
				    	else if(count($array_campos_por_solo_coma)==210)
				    	{
				    		$cont=0;
				    	...
				    	else if(count($array_campos_por_tubo)>=211 )
				    	{
				    		
							if(  trim($array_campos_por_tubo[210])=="" )
							{
					    		$cont=0;
					    		while ($cont<210 ) 
					    		{
					    		...
					    		$cumplio_con_210_campos=true;
					    		$se_arreglo_linea=true;
					    		echo "arreglando 211 o mas campos a 210 tubo<br>";
					    		ob_flush();
								flush();
				    		}
				    		else
				    		{
				    			echo "El campo 211 no es vacio para tubo --empieza--".trim($array_campos_por_tubo[210])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin if
				    	else if(count($array_campos_por_punto_y_coma)>=211 )
				    	{
				    		
							if( trim($array_campos_por_punto_y_coma[210])=="")
							{
					    		$cont=0;
					    		while ($cont<210 ) 
					    		{
					    		...
					    		$cumplio_con_210_campos=true;
					    		$se_arreglo_linea=true;
					    		echo "arreglando 211 o mas campos a 210 punto y coma<br>";
					    		ob_flush();
								flush();
				    		}//fin if
				    		else
				    		{
				    			echo "El campo 211 no es vacio para punto y coma --empieza--".trim($array_campos_por_punto_y_coma[210])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin else if
				    	else if(count($array_campos_por_tabulacion)>=211 )
				    	{
				    		
							if( trim($array_campos_por_tabulacion[210])=="")
							{
					    		$cont=0;
					    		while ($cont<210 ) 
					    		{
					    		...
					    		$cumplio_con_210_campos=true;
					    		$se_arreglo_linea=true;
					    		echo "arreglando 211 o mas campos a 210 tabulacion<br>";
					    		ob_flush();
								flush();
				    		}//fin if
				    		else
				    		{
				    			echo "El campo 211 no es vacio para tabulacion --empieza--".trim($array_campos_por_tabulacion[210])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin else if
				    	else if(count($array_campos_por_solo_coma)>=211 )
				    	{
				    		
							if( trim($array_campos_por_solo_coma[210])=="")
							{
					    		$cont=0;
					    		while ($cont<210 ) 
					    		{
				    		...
				    		{
				    			//el 210 es el campo 211 contado desde cero
				    			echo "El campo 211 no es vacio para tabulacion --empieza--".trim($array_campos_por_solo_coma[210])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin else if
				...
				foreach ($Sheets as $Index => $Name)
				{
					...
					foreach ($Reader as $Row)
					{
				    	...
				    	else if(count($Row)>=211 )
				    	{
				    		...
				    		{
				    			echo "El campo 211 no es vacio para fila excel --empieza--".trim($Row[210])."--termina--<br>";
					    		ob_flush();
								flush();
				...
				foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) 
				{
				    ...
				    foreach ($worksheet->getRowIterator() as $row) 
				    {
				        ...
				        foreach ($cellIterator as $cell) 
				        {
				            ...
				            if($numeroColumna<=209 && $iniciaPor2==true)
				            {
				            	if($cont!=0){$linea_resultado.="\t";}
				            	if (!is_null($cell)) 
				            	{
				            ...
				            if($iniciaPor2==true && $numeroColumna>=209)
				            {
				            	$archivo_final=fopen($ruta_archivo_final, "a");
						        if($primera_linea==true)
						        {
