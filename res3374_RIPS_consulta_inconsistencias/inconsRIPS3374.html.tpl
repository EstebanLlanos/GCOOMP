			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario"  method="post">
						...
						<tr>
						<td style="text-align:left;"><input type='text' id='year_de_corte' name='year_de_corte' class='campo_azul' placeholder='AAAA' maxlength="4" onkeypress="return isNumberKey(event)" onchange="consultar_numeros_remision();" onkeyup="consultar_numeros_remision();"/> {$campo_fechas_corte}</td>
						</tr>
						<tr>
						<td style="text-align:left;">
