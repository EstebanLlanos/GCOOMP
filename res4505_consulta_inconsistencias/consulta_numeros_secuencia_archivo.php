...
if(isset($_REQUEST["prestador"]) && isset($_REQUEST["nombre_archivo"]) &&  $_REQUEST["nombre_archivo"]!="" && $_REQUEST["prestador"]!="none" )
{
	...
	//parte base de datos
	$query_consulta="";
	$query_consulta.="SELECT numero_secuencia FROM gioss_numero_secuencia_archivos_4505 WHERE ";
	$query_consulta.=" nombre_archivo_4505='$nombre_archivo' ";
	$query_consulta.=" AND ";
	...
	{		
		...
		$selector_numeros_remision.="<option value='none' selected>Seleccione un numero de secuencia de los asociados al archivo 4505</option>";
