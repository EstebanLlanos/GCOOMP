...
<html>
    <head>
       ...
       <title>Consulta 4505 Prestador-IPS</title>
    </head>
    <body>
        <div id="contenedor" >
        <table>
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post">
						...
						<tr>
						<td style="text-align:left;">Prestador:</td>
						</tr>
						<tr>
						<td style="text-align:left;">{$campo_prestador}</td>
						</tr>
						
						<tr>
						<td style="text-align:left;">EAPB:</td>
						</tr>
						<tr>
