...
function enviar()
{
	...
	var busqueda_tipo_consulta=document.getElementById('por_tipo_consulta');
	var busqueda_especialidad=document.getElementById('por_especialidad');
	
	if (busqueda_especialidad.checked==false && busqueda_tipo_consulta.checked==false)
	{
		mensaje_error+="Seleccione un criterio de busqueda, sea por tipo actividad consulta o especialidad.<br></br>";
	}
...
function mostrar_especialidad_o_tipo_de_consulta()
{
	var busqueda_tipo_consulta=document.getElementById('por_tipo_consulta');
	var busqueda_especialidad=document.getElementById('por_especialidad');
	
	if(busqueda_tipo_consulta.checked==true)
	{
		document.getElementById("tr_titulo_tipo_consulta").style.display="inline";
		document.getElementById("tr_selector_tipo_consulta").style.display="inline";
		document.getElementById("tr_titulo_especialidad").style.display="none";
		document.getElementById("tr_selector_especialidad").style.display="none";
	}
	if(busqueda_especialidad.checked==true)
	{
		document.getElementById("tr_titulo_especialidad").style.display="inline";
		document.getElementById("tr_selector_especialidad").style.display="inline";
		document.getElementById("tr_titulo_tipo_consulta").style.display="none";
		document.getElementById("tr_selector_tipo_consulta").style.display="none";
	}
}
