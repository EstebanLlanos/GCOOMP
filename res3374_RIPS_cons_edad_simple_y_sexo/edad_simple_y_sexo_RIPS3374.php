...
$smarty->display('edad_simple_y_sexo_RIPS3374.html.tpl');
...
if(isset($_POST["year_de_validacion"]) && isset($_POST["periodo"]) && isset($_POST["eapb"]) && isset($_POST["sexo"])
   ...
   && (
       ($_POST["criterio_busqueda"]=="cb_1_tipo_consulta" && isset($_POST["selector_actividad_consulta"]) )
       ||
       ($_POST["criterio_busqueda"]=="cb_2_especialidad" && isset($_POST["selector_especialidad"]))
       )
   )
{
	...
	$actividad_consulta="";
	$especialidad="";
	if($criterio_busqueda_esp_o_tc=="cb_1_tipo_consulta")
	{
		$actividad_consulta=$_POST["selector_actividad_consulta"];
	}
	if($criterio_busqueda_esp_o_tc=="cb_2_especialidad")
	{
	...
	$nombre_vista_para_codigo_actividad="vcodactr_".$nick_user."_".$tipo_id."_".$identificacion;
	
	$sql_vista_calidad_de_datos="";
	$sql_vista_calidad_de_datos.="CREATE OR REPLACE VIEW $nombre_vista_para_codigo_actividad ";
	$sql_vista_calidad_de_datos.=" AS SELECT DISTINCT ac.codigo_cups_consulta ";
	$sql_vista_calidad_de_datos.=" FROM gioss_archivo_cargado_ac ac ";
	$sql_vista_calidad_de_datos.=" INNER JOIN gioss_tabla_estado_informacion_rips ei ON (ac.numero_secuencia=ei.numero_secuencia)";
	$sql_vista_calidad_de_datos.=" INNER JOIN gioss_tipo_consulta_cups_rips tcp ON (ac.codigo_cups_consulta=tcp.codigo_procedimiento)";
	$sql_vista_calidad_de_datos.=" WHERE  ";
	$sql_vista_calidad_de_datos.=" (ac.fecha_validacion_exito BETWEEN '$fecha_inicio' AND '$fecha_fin' ) ";
	$sql_vista_calidad_de_datos.=" AND ";
	$sql_vista_calidad_de_datos.=" ac.codigo_eapb='$cod_eapb' ";
	if($cod_sexo!="" && $cod_sexo!="A")
	{
		$sql_vista_calidad_de_datos.=" AND ";
		$sql_vista_calidad_de_datos.=" ac.sexo_afiliado='$cod_sexo' ";
	}
	if($codigo_departamento!="")
	{
		$sql_vista_calidad_de_datos.=" AND ";
		$sql_vista_calidad_de_datos.=" ei.codigo_departamento='$codigo_departamento' ";
	}
	if($codigo_departamento!="" && $codigo_municipio!="")
	{
		$sql_vista_calidad_de_datos.=" AND ";
		$sql_vista_calidad_de_datos.=" ei.codigo_municipio='$codigo_municipio' ";
	}
	if($cod_prestador!="")
	{
		$sql_vista_calidad_de_datos.=" AND ";
		$sql_vista_calidad_de_datos.=" ac.codigo_prestador_servicios_salud='$cod_prestador' ";
	}
	
	if($criterio_busqueda_esp_o_tc=="cb_1_tipo_consulta" && $actividad_consulta!="none")
	{
		$sql_vista_calidad_de_datos.=" AND ";
		$sql_vista_calidad_de_datos.=" tcp.tipo_de_consulta='$actividad_consulta' ";
	}
	if($criterio_busqueda_esp_o_tc=="cb_2_especialidad" && $especialidad!="none")
	{
		$sql_vista_calidad_de_datos.=" AND ";
		$sql_vista_calidad_de_datos.=" tcp.tipo_de_profesional='$especialidad' ";
	}
	...
	while($contador_offset<$numero_registros_vista)
	{
		...
		if(count($resultado_para_edad_simple_y_sexo)>0 && is_array($resultado_para_edad_simple_y_sexo))
		{
			...
			if($hubo_resultados==false)
			{
				...
				if($criterio_busqueda_esp_o_tc=="cb_1_tipo_consulta")
				{
					$titulos.="Tipo Actividad Consulta,";
				}
				if($criterio_busqueda_esp_o_tc=="cb_2_especialidad")
				{
			...
			foreach($resultado_para_edad_simple_y_sexo as $resultado)
			{
				...
				if($criterio_busqueda_esp_o_tc=="cb_1_tipo_consulta")
				{
					$string_descripcion_tipo_consulta="";
					$query_descripcion_tipo_consulta="";
					$query_descripcion_tipo_consulta.=" SELECT * FROM gioss_tipo_consulta_cups_rips ccr ";
					$query_descripcion_tipo_consulta.=" INNER JOIN gioss_tipo_consulta_rips tcr ON (ccr.tipo_de_consulta=tcr.codigo_tipo_consulta_rips) ";
					$query_descripcion_tipo_consulta.=" WHERE codigo_procedimiento='".$resultado["codigo_cups_consulta"]."'; ";
					...
					{
						$string_descripcion_tipo_consulta=$res_descripcion_tipo_consulta[0]["descripcion_tipo_consulta_rips"];
					}
					$linea_edad_simple_y_sexo.=$string_descripcion_tipo_consulta.",";
				}
				if($criterio_busqueda_esp_o_tc=="cb_2_especialidad")
				{
					$string_descripcion_especialidad="";
					$query_descripcion_especialidad="";
					$query_descripcion_especialidad.=" SELECT * FROM gioss_tipo_consulta_cups_rips ccr ";
					$query_descripcion_especialidad.=" INNER JOIN gioss_tipo_profesional_consulta_cups_rips tpcr ON (ccr.tipo_de_profesional=tpcr.codigo_tipo_profesional_consulta_rips) ";
					$query_descripcion_especialidad.=" WHERE codigo_procedimiento='".$resultado["codigo_cups_consulta"]."'; ";
					...
					{
						$string_descripcion_especialidad=$res_descripcion_especialidad[0]["descripcion_tipo_profesional_consulta_rips"];
					}
					$linea_edad_simple_y_sexo.=$string_descripcion_especialidad.",";
				}
				
				$linea_edad_simple_y_sexo.=$resultado["codigo_cups_consulta"].",";
				
				$string_descripcion_actividad="";
				$query_descripcion_actividad="";
				$query_descripcion_actividad.=" SELECT * FROM gioss_cups WHERE codigo_procedimiento='".$resultado["codigo_cups_consulta"]."';";
				...
				while($cont_edad_linea<=120)
				{
					...
					$sql_consulta_contador_edad.=" AND ";
					$sql_consulta_contador_edad.=" ac.codigo_cups_consulta='".$resultado["codigo_cups_consulta"]."' ";
					$sql_consulta_contador_edad.=" AND ";
					...
					{
						$sql_consulta_contador_edad.=" AND ";
						$sql_consulta_contador_edad.=" tcp.tipo_de_consulta='$actividad_consulta' ";
					}
					if($criterio_busqueda_esp_o_tc=="cb_2_especialidad" && $especialidad!="none")
					{
						$sql_consulta_contador_edad.=" AND ";
				...
				if($cont_para_verificar_fin_array==count($resultado_para_edad_simple_y_sexo)-1)
				{
					...
					while($cont_edad_linea_total<=120)
					{
						...
						{
							$sql_consulta_contador_total_edad.=" AND ";
							$sql_consulta_contador_total_edad.=" tcp.tipo_de_consulta='$actividad_consulta' ";
						}
						if($criterio_busqueda_esp_o_tc=="cb_2_especialidad" && $especialidad!="none")
						{
							$sql_consulta_contador_total_edad.=" AND ";
