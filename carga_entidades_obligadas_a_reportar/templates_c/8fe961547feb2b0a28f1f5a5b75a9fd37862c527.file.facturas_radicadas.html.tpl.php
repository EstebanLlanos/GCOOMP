<?php /* Smarty version Smarty-3.1.17, created on 2014-08-29 11:18:29
         compiled from "facturas_radicadas.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1789653f3d692ccee25-21404689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8fe961547feb2b0a28f1f5a5b75a9fd37862c527' => 
    array (
      0 => 'facturas_radicadas.html.tpl',
      1 => 1409329107,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1789653f3d692ccee25-21404689',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_53f3d69332a374_25998155',
  'variables' => 
  array (
    'menu' => 1,
    'nombre' => 1,
...
<?php if ($_valid && !is_callable('content_53f3d69332a374_25998155')) {function content_53f3d69332a374_25998155($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
			...
			<table>
				...
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post" enctype= "multipart/form-data">
						...
						<tr>
						<td style="text-align:left;">
						<h5>Registre las facturas radicadas para poder realizar el reporte de quienes cumplieron la entrega del RIPS.</h5>
						</td>
						</tr>
...
<div id='fecha_corte_periodo_actual' name='fecha_corte_periodo_actual' style="position:absolute;left:25%;top:5%"></div></td>
						...
						<tr>
							...
							<table id='tabla_seleccion_archivos' style='display:inline;'>
								...
								<h5>CARGAR ARCHIVO CON LOS DATOS<BR>DE LAS FACTURAS A RADICAR:</h5>
								</td>
						...
						<input type="button" class="btn btn-success color_boton" value="Limpiar" id='limpiar_factura' name='limpiar_factura' onclick="limpiar();"/>
						</td>
						</tr>
