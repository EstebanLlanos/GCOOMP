<?php /* Smarty version Smarty-3.1.17, created on 2018-03-15 09:11:38
         ...
         <div id="modPrincipal">
			<table>
				<tr>
					...
					<td>
					<form name="formulario" id="formulario" action="formulario_auditoria_CANCER.php" method="post" enctype= "multipart/form-data">
						<table>
						<tr>
