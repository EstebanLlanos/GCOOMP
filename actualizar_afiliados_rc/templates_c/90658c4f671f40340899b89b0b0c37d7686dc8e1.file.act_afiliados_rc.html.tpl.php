<?php /* Smarty version Smarty-3.1.17, created on 2016-05-26 10:24:21
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario" action="" method="post" enctype= "multipart/form-data">
						...
						<tr>
						<td style="text-align:left;">
						<input type="text" name="nombre_tabla" id="nombre_tabla" style="width:300px;" class='campo_azul' placeholder="nombre tabla" value="gioss_afiliados_eapb_rc" readonly />
						</td>
						</tr>
						...
						codigo_eapb,tipo_id_eapb,numero_id_eapb,tipo_id_afiliado,id_afiliado,primer_nombre,segundo_nombre,primer_apellido,segundo_apellido,codigo_tipo_regimen,cod_tipo_afiliado,cod_tipo_cotizante,cod_estado_afiliado,cod_ocupacion,sexo,fecha_nacimiento,cod_mpio,cod_dpto,cod_zona
						</textarea>
						</td>
						</tr>
