...
$smarty->display('conversor_excel_plano0123.html.tpl');
...
//usuario normal ips
/*
INSERT INTO gios_menus_opciones_sistema(id_principal,id_padre,nombre_opcion,descripcion_ayuda,tiene_submenus,ruta_interfaz,prioridad_jerarquica) VALUES ('229','171','Excel Plano 0123','',FALSE,'..|conversor_excel_plano0123|conversor_excel_plano0123.php','33.05');
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('229','5'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('229','4'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('229','3');
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('229','2'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('229','1'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('229','13'); 
*/
...
$nombre_carpeta_origen="origcv0123".$fecha_para_archivo;
$nombre_carpeta_destino="destcv0123".$fecha_para_archivo;
	    	...
	    	if($es_excel_archivo_actual==false)
	    	{
				...
				if ($lectorArchivo) 
				{
				    ...
				    while (($buffer = fgets($lectorArchivo, 9999)) !== false) 
				    {
				    	...
				    	$cumplio_con_95_campos=false;
				    	$linea_resultado="";
				    	if(count($array_campos_por_tubo)==95 )
				    	{
				    		$cont=0;
				    		...
				    		$cumplio_con_95_campos=true;
				    		$se_arreglo_linea=true;
				    	}//fin if
				    	else if(count($array_campos_por_punto_y_coma)==95)
				    	{
				    		$cont=0;
				    	...
				    	else if(count($array_campos_por_tabulacion)==95)
				    	{
				    		$cont=0;
				    	...
				    	else if(count($array_campos_por_solo_coma)==95)
				    	{
				    		$cont=0;
				    	...
				    	else if(count($array_campos_por_tubo)>=96 )
				    	{
				    		
							if(  trim($array_campos_por_tubo[95])=="" )
							{
					    		$cont=0;
					    		while ($cont<95 ) 
					    		{
					    		...
					    		$cumplio_con_95_campos=true;
					    		$se_arreglo_linea=true;
					    		echo "arreglando 96 o mas campos a 95 tubo<br>";
					    		ob_flush();
								flush();
				    		}
				    		else
				    		{
				    			echo "El campo 96 no es vacio para tubo --empieza--".trim($array_campos_por_tubo[95])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin if
				    	else if(count($array_campos_por_punto_y_coma)>=96 )
				    	{
				    		
							if( trim($array_campos_por_punto_y_coma[95])=="")
							{
					    		$cont=0;
					    		while ($cont<95 ) 
					    		{
					    		...
					    		$cumplio_con_95_campos=true;
					    		$se_arreglo_linea=true;
					    		echo "arreglando 96 o mas campos a 95 punto y coma<br>";
					    		ob_flush();
								flush();
				    		}//fin if
				    		else
				    		{
				    			echo "El campo 96 no es vacio para punto y coma --empieza--".trim($array_campos_por_punto_y_coma[95])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin else if
				    	else if(count($array_campos_por_tabulacion)>=96 )
				    	{
				    		
							if( trim($array_campos_por_tabulacion[95])=="")
							{
					    		$cont=0;
					    		while ($cont<95 ) 
					    		{
					    		...
					    		$cumplio_con_95_campos=true;
					    		$se_arreglo_linea=true;
					    		echo "arreglando 96 o mas campos a 95 tabulacion<br>";
					    		ob_flush();
								flush();
				    		}//fin if
				    		else
				    		{
				    			echo "El campo 96 no es vacio para tabulacion --empieza--".trim($array_campos_por_tabulacion[95])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin else if
				    	else if(count($array_campos_por_solo_coma)>=96 )
				    	{
				    		
							if( trim($array_campos_por_solo_coma[95])=="")
							{
					    		$cont=0;
					    		while ($cont<95 ) 
					    		{
				    		...
				    		{
				    			//el 95 es el campo 96 contado desde cero
				    			echo "El campo 96 no es vacio para tabulacion --empieza--".trim($array_campos_por_solo_coma[95])."--termina--<br>";
					    		ob_flush();
								flush();
				    		}
				    	}//fin else if
				...
				foreach ($Sheets as $Index => $Name)
				{
					...
					foreach ($Reader as $Row)
					{
				    	...
				    	else if(count($Row)>=96 )
				    	{
				    		...
				    		{
				    			echo "El campo 96 no es vacio para fila excel --empieza--".trim($Row[95])."--termina--<br>";
					    		ob_flush();
								flush();
				...
				foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) 
				{
				    ...
				    foreach ($worksheet->getRowIterator() as $row) 
				    {
				        ...
				        foreach ($cellIterator as $cell) 
				        {
				            ...
				            if($numeroColumna<=94 && $iniciaPor2==true)
				            {
				            	if($cont!=0){$linea_resultado.="\t";}
				            	if (!is_null($cell)) 
				            	{
				            ...
				            if($iniciaPor2==true && $numeroColumna>=94)
				            {
				            	$archivo_final=fopen($ruta_archivo_final, "a");
						        if($primera_linea==true)
						        {
