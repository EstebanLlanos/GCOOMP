	...
	class SpreadsheetReader_XLSX implements Iterator, Countable
	{
		...
		public function ChangeSheet($Index)
		{
			...
			if (isset($Sheets[$Index]))
			{
				...
				echo print_r($SheetIndexes,true)." RS ".$RealSheetIndex."<br>";

			}

			$TempWorksheetPath = $this -> TempDir.'xl/worksheets/sheet'.$RealSheetIndex.'.xml';

			echo "TempWorksheetPath antes de condicional $TempWorksheetPath <br>";

			if ($RealSheetIndex !== false && is_readable($TempWorksheetPath))
			{
				$this -> WorksheetPath = $TempWorksheetPath;

				echo "Ruta temporal WorksheetPath ".$this -> WorksheetPath."<br>";
			...
			{
				echo "fallo condicional, Ruta temporal WorksheetPath <br>";
			}
