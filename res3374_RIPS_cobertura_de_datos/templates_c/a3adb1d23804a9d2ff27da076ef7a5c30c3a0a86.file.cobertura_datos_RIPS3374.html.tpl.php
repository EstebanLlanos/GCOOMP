<?php /* Smarty version Smarty-3.1.17, created on 2014-09-27 11:41:15
         compiled from "cobertura_datos_RIPS3374.html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8305541668813b9ca5-50710734%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3adb1d23804a9d2ff27da076ef7a5c30c3a0a86' => 
    array (
      0 => 'cobertura_datos_RIPS3374.html.tpl',
      1 => 1411416012,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8305541668813b9ca5-50710734',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_54166881b91b88_55204925',
  'variables' => 
  array (
    'menu' => 1,
    'nombre' => 1,
...
<?php if ($_valid && !is_callable('content_54166881b91b88_55204925')) {function content_54166881b91b88_55204925($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">       
        <script type="text/javascript" src="../librerias_externas/jquery_min/jquery-1.10.2.js"> </script>       
        <script type="text/javascript" src="cobertura_datos_RIPS3374.js"></script>
        <script type="text/javascript" src="../librerias_externas/bootstrap/js/bootstrap.js"></script>
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap.css" rel="stylesheet" />
        <link type="text/css" href="../librerias_externas/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
        <link type="text/css" href="cobertura_datos_RIPS3374.css" rel="stylesheet" />
			...
			<table>
				<tr>
					...
					<form name="formulario" id="formulario"  method="post">
						...
						<h5 style="color:blue;">COBERTURA DE REPORTES ESPERADOS RIPS(EAPB):</h5>
						<br>
						&#32
						</td>
						</tr>
						...
						<td style="text-align:left;">
							...
							<div id='div_mensaje_error' class="sec2" style="width:90%;display:none;">
								...
								<div class="alert-success alert-block alert-error fade in">
									...
									<a class="close" data-dismiss="alert" href="#">&times</a>
									<h4 id='titulo_mensaje_error' class="alert-heading" style="text-align: center">&iexclError al generar el reporte de cobertura de datos!</h4>
