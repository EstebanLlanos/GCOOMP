...
$(function() 
{
    ...
    */
    $("#eapb").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Por favor, seleccione la entidad que reportara<br>'});
...
function enviar_formulario()
{
	...
	*/
	...
	if($('#eapb').val()=="none")
	{
		mensaje_error+="Seleccione la entidad administradora que realizara el reporte.<br></br>";
	}
