...
$query_periodos_rips="SELECT * FROM gioss_periodo_reporte_0123_hf;";
...
$selector_periodo.="<option value='13'>Anual (Marzo 03-31)</option>";
...
$smarty->display('repobligHF0123.html.tpl');
...
if(isset($_POST["year_de_corte"]) && isset($_POST['eapb']) && $_POST['eapb']!="none" && $_POST["year_de_corte"]!="" && ctype_digit($_POST["year_de_corte"]) )
{
	...
	{
	   $fecha_ini_bd="04/01/".(intval($year)-1);
	   $fecha_fin_bd="03/31/".$year;
	   $fecha_de_corte_periodo="03/31/".$year;
	}
	//FIN ANUAL
	...
	$query_verificacion_esta_siendo_procesado.=" SELECT * FROM gioss_0123_esta_consolidando_ro_actualmente ";
	...
	$query_verificar_nombre_archivo="SELECT * FROM gioss_archivos_obligatorios_reportados_hf WHERE codigo_entidad_eapb_generadora='$cod_eapb' AND nombre_archivo_hf='$nombre_zip_sin_consecutivo' ;";
		...
		if(isset($array_permisos[0]))
		{
			if($array_permisos[0]=="SI")
			{
				...
				if($accion=="validada" && count($resultado_verificar_nombre_archivo)>0 )
				{
					...
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_hf0123_exitoso ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_hf='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					...
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_hf0123_exitoso_duplicado ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_hf='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
					...
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_dupl_incluidos_excluidos_hor_hf0123 ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_hf='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
				...
				{
					$delete_consolidado_anterior="";
					$delete_consolidado_anterior.="DELETE FROM gioss_consulta_reporte_obligatorio_hf0123_rechazado ";
					$delete_consolidado_anterior.=" WHERE nombre_archivo_hf='$nombre_zip_sin_consecutivo' AND codigo_entidad_eapb_generadora='$cod_eapb'; ";
					$error_bd_seq="";		
					$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($delete_consolidado_anterior, $error_bd_seq);
					if($error_bd_seq!="")
	...
	if($ya_se_reporto_archivo==false)
	{
		...
		$query_insert_esta_siendo_procesado.=" INSERT INTO gioss_0123_esta_consolidando_ro_actualmente ";
		$query_insert_esta_siendo_procesado.=" ( ";
		...
		$sql_datos_reporte_obligatorio.="CREATE OR REPLACE VIEW vsrohf_".$nick_user."_".$tipo_id."_".$identificacion." ";
		$sql_datos_reporte_obligatorio.=" AS  ";	
		if($accion=="validada")
		{
			$sql_datos_reporte_obligatorio .=" ( ";
			$sql_datos_reporte_obligatorio .=" SELECT * from gioss_tabla_registros_cargados_exito_r0123_hf WHERE ";			
			...
			$sql_datos_reporte_obligatorio .=" SELECT * from gioss_tabla_registros_no_cargados_rechazados_r0123_hf WHERE ";			
			$sql_datos_reporte_obligatorio .=" (fecha_corte BETWEEN '".$fecha_ini_bd."'  AND '".$fecha_fin_bd."' )  ";
			$sql_datos_reporte_obligatorio .=" AND ";
			$sql_datos_reporte_obligatorio .=" estado_registro='1' ";
			$sql_datos_reporte_obligatorio .=" AND ";
		...
		$sql_query_numero_registros.="SELECT count(*) as contador FROM vsrohf_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		...
		while($contador_offset<$numero_registros)
		{
			...
			$verificar_si_ejecucion_fue_cancelada.=" SELECT esta_ejecutando FROM gioss_0123_esta_consolidando_ro_actualmente ";
			...
			$sql_query_busqueda="";
			$sql_query_busqueda.="SELECT * FROM vsrohf_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite OFFSET $contador_offset;  ";
			...
			foreach($resultados_query_vih as $linea_consulta)
			{
				...
				$regimen_afiliacion=$linea_consulta["campo_hf_de_numero_orden_2"];
				...
				if($accion=="validada")
				{
					$sql_delete_duplicados.=" gioss_consulta_reporte_obligatorio_hf0123_exitoso ";
				}
				else if($accion=="rechazada")
				{
					$sql_delete_duplicados.=" gioss_consulta_reporte_obligatorio_hf0123_rechazado ";
				}
				...
				$sql_delete_duplicados.=" AND ";
				$sql_delete_duplicados.=" campo_hf_de_numero_orden_4='".trim($linea_consulta["campo_hf_de_numero_orden_4"])."'  ";
				$sql_delete_duplicados.=" AND ";
				$sql_delete_duplicados.=" campo_hf_de_numero_orden_5='".trim($linea_consulta["campo_hf_de_numero_orden_5"])."'  ";
				$sql_delete_duplicados.=" ; ";
				$error_bd_seq="";		
				...
				*/
				...
				if($accion=="validada")
				{
					...
					$sql_hubo_en_duplicados.=" gioss_consulta_reporte_obligatorio_hf0123_exitoso_duplicado ";
					...
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" nombre_archivo_hf='".$nombre_zip_sin_consecutivo."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_hf_de_numero_orden_4='".trim($linea_consulta["campo_hf_de_numero_orden_4"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" campo_hf_de_numero_orden_5='".trim($linea_consulta["campo_hf_de_numero_orden_5"])."'  ";
					$sql_hubo_en_duplicados.=" AND ";
					$sql_hubo_en_duplicados.=" ( ";
					...
					if(count($registros_desde_tabla_duplicados)>0 && is_array($registros_desde_tabla_duplicados))
					{
						...
						$sql_insert_duplicados_rep_oblig_hf.=" numero_secuencia, ";
						$sql_insert_duplicados_rep_oblig_hf.=" numero_registro, ";
						$sql_insert_duplicados_rep_oblig_hf.=" regimen, ";
						$sql_insert_duplicados_rep_oblig_hf.=" fecha_corte_reporte, ";
						$sql_insert_duplicados_rep_oblig_hf.=" fecha_de_generacion, ";
						$sql_insert_duplicados_rep_oblig_hf.=" hora_generacion, ";
						$sql_insert_duplicados_rep_oblig_hf.=" codigo_entidad_eapb_generadora, ";
						$sql_insert_duplicados_rep_oblig_hf.=" codigo_entidad_prestadora, ";
						$sql_insert_duplicados_rep_oblig_hf.=" nombre_archivo_hf ";
						$sql_insert_duplicados_rep_oblig_hf.=" ) ";
						...
						$sql_insert_duplicados_rep_oblig_hf.="'".$linea_consulta["numero_secuencia"]."',";
						$sql_insert_duplicados_rep_oblig_hf.="'".$linea_consulta["fila"]."',";				
						$sql_insert_duplicados_rep_oblig_hf.="'".$regimen_almacenado."',";								
						$sql_insert_duplicados_rep_oblig_hf.="'".$fecha_corte_bd."',";
						$sql_insert_duplicados_rep_oblig_hf.="'".$fecha_actual."',";
						$sql_insert_duplicados_rep_oblig_hf.="'".$tiempo_actual."',";
						$sql_insert_duplicados_rep_oblig_hf.="'".$linea_consulta["codigo_eapb_a_reportar"]."',";
						$sql_insert_duplicados_rep_oblig_hf.="'".$linea_consulta["codigo_prestador_reportante"]."',";
						$sql_insert_duplicados_rep_oblig_hf.="'".$nombre_zip_sin_consecutivo."'";
						$sql_insert_duplicados_rep_oblig_hf.=" ) ";
						$sql_insert_duplicados_rep_oblig_hf.=" ; ";
						$error_bd_seq="";		
						$bool_hubo_error_query=$conexionbd->insertar_no_warning_get_error_no_crea_cierra($sql_insert_duplicados_rep_oblig_hf, $error_bd_seq);
						if($error_bd_seq!="")
						{
					...
					$sql_query_ultimo_dejado.=" gioss_consulta_reporte_obligatorio_hf0123_exitoso ";
					...
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" nombre_archivo_hf='".$nombre_zip_sin_consecutivo."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_hf_de_numero_orden_4='".trim($linea_consulta["campo_hf_de_numero_orden_4"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" campo_hf_de_numero_orden_5='".trim($linea_consulta["campo_hf_de_numero_orden_5"])."'  ";
					$sql_query_ultimo_dejado.=" AND ";
					$sql_query_ultimo_dejado.=" ( ";
					...
					if(count($registro_ultimo_dejado)>0 && is_array($registro_ultimo_dejado))
					{
						...
						foreach($registro_ultimo_dejado as $ultimo_registro)
						{
							...
							$sql_insert_duplicados_rep_oblig_hf.="'".$ultimo_registro["numero_secuencia"]."',";
							$sql_insert_duplicados_rep_oblig_hf.="'".$ultimo_registro["numero_registro"]."',";	
							$sql_insert_duplicados_rep_oblig_hf.="'".$regimen_almacenado."',";								
							$sql_insert_duplicados_rep_oblig_hf.="'".$fecha_corte_bd."',";
							$sql_insert_duplicados_rep_oblig_hf.="'".$fecha_actual."',";
							$sql_insert_duplicados_rep_oblig_hf.="'".$tiempo_actual."',";
							$sql_insert_duplicados_rep_oblig_hf.="'".$ultimo_registro["codigo_entidad_eapb_generadora"]."',";
							$sql_insert_duplicados_rep_oblig_hf.="'".$ultimo_registro["codigo_entidad_prestadora"]."',";
							$sql_insert_duplicados_rep_oblig_hf.="'".$nombre_zip_sin_consecutivo."'";
							$sql_insert_duplicados_rep_oblig_hf.=" ) ";
							$sql_insert_duplicados_rep_oblig_hf.=" ; ";
							$error_bd_seq="";		
					...
					$sql_delete_duplicados.=" codigo_entidad_eapb_generadora='".$cod_eapb."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" nombre_archivo_hf='".$nombre_zip_sin_consecutivo."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_hf_de_numero_orden_4='".trim($linea_consulta["campo_hf_de_numero_orden_4"])."'  ";
					$sql_delete_duplicados.=" AND ";
					$sql_delete_duplicados.=" campo_hf_de_numero_orden_5='".trim($linea_consulta["campo_hf_de_numero_orden_5"])."'  ";
				...
				if($hubo_duplicado==false)
				{
					...
					if($accion=="validada")
					{
						$sql_insert_consulta_reporte_obligatorio.=" gioss_consulta_reporte_obligatorio_hf0123_exitoso ";
					}
					else if($accion=="rechazada")
					{
					...
					$sql_insert_consulta_reporte_obligatorio.=" nombre_archivo_hf ";
					$sql_insert_consulta_reporte_obligatorio.=" ) ";
			...
			$query_update_esta_siendo_procesado.=" UPDATE gioss_0123_esta_consolidando_ro_actualmente ";
		...
		if($accion=="validada" && $hubo_al_menos_un_duplicado==true)
		{
			...
			$sql_vista_duplicados_reporte_obligatorio.="CREATE OR REPLACE VIEW vduplhf_".$nick_user."_".$tipo_id."_".$identificacion." ";
			$sql_vista_duplicados_reporte_obligatorio.=" AS  ";					
			$sql_vista_duplicados_reporte_obligatorio .="SELECT * from gioss_consulta_reporte_obligatorio_hf0123_exitoso_duplicado WHERE ";				
			...
			$sql_vista_duplicados_reporte_obligatorio.=" AND ";
			$sql_vista_duplicados_reporte_obligatorio.=" nombre_archivo_hf='".$nombre_zip_sin_consecutivo."'  ";
			$sql_vista_duplicados_reporte_obligatorio.=" ORDER BY campo_hf_de_numero_orden_4 asc,campo_hf_de_numero_orden_5 asc,  numero_secuencia asc ";
			$sql_vista_duplicados_reporte_obligatorio.=";";
			$error_bd_seq="";		
			...
			$sql_numero_de_duplicados.=" SELECT count(*) as numero_registros FROM vduplhf_".$nick_user."_".$tipo_id."_".$identificacion."  ; ";
			$error_bd_seq="";
			...
			if($numero_duplicados>0)
			{
				...
				while($contador_offset_duplicados<$numero_duplicados)
				{
					...
					$sql_query_busqueda_duplicados.="SELECT * FROM vduplhf_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite_duplicados OFFSET $contador_offset_duplicados;  ";
					$error_bd_seq="";
					$resultados_query_hf0123_duplicados=$coneccionBD->consultar_no_warning_get_error_no_crea_cierra($sql_query_busqueda_duplicados,$error_bd_seq);
					if($error_bd_seq!="")
					{
					...
					if(count($resultados_query_hf0123_duplicados)>0 && is_array($resultados_query_hf0123_duplicados))
					{
						...
						{
							$tipo_id_duplicado_actual=trim($duplicado_actual["campo_hf_de_numero_orden_4"]);
							$numero_id_duplicado_actual=trim($duplicado_actual["campo_hf_de_numero_orden_5"]);
							...
							$sql_query_ya_se_proceso.=" gioss_consulta_reporte_obligatorio_hf0123_exitoso ";
							...
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" nombre_archivo_hf='".$nombre_zip_sin_consecutivo."'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_hf_de_numero_orden_4='$tipo_id_duplicado_actual'  ";
							$sql_query_ya_se_proceso.=" AND ";
							$sql_query_ya_se_proceso.=" campo_hf_de_numero_orden_5='$numero_id_duplicado_actual'  ";
							$sql_query_ya_se_proceso.=" ; ";
							$error_bd_seq="";
							...
							{
								if($numero_id_duplicado_actual==trim($registro_si_ya_se_proceso[0]["campo_hf_de_numero_orden_5"]))
								{
							...
							{
								$nombre_vista_duplicados_del_duplicado_actual="vduplacthf_".$nick_user."_".$tipo_id."_".$identificacion;
								...
								$sql_vista_duplicado_actual .="SELECT * from vduplhf_".$nick_user."_".$tipo_id."_".$identificacion." WHERE ";				
								...
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" nombre_archivo_hf='".$nombre_zip_sin_consecutivo."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_hf_de_numero_orden_4='".$tipo_id_duplicado_actual."'  ";
								$sql_vista_duplicado_actual.=" AND ";
								$sql_vista_duplicado_actual.=" campo_hf_de_numero_orden_5='".$numero_id_duplicado_actual."'  ";
								$sql_vista_duplicado_actual.=" ORDER BY campo_hf_de_numero_orden_4 asc,campo_hf_de_numero_orden_5 asc, numero_secuencia asc ";
								$sql_vista_duplicado_actual.=";";
								$error_bd_seq="";		
		...
		if($mensajes_error_bd=="" && count($array_rutas_archivos_generados)>0 && $numero_registros>0)
		{
			...
			$sql_insert_verificador_reportados.=" INSERT INTO gioss_archivos_obligatorios_reportados_hf ";
			$sql_insert_verificador_reportados.=" ( ";
			$sql_insert_verificador_reportados.=" usuario_que_genero, ";
			$sql_insert_verificador_reportados.=" nombre_archivo_hf, ";
		...
		$sql_vista_consulta_reporte_obligatorio.="CREATE OR REPLACE VIEW vcrohf_".$nick_user."_".$tipo_id."_".$identificacion." ";
		if($estado_validacion_seleccionado=="validada")
		{
			$sql_vista_consulta_reporte_obligatorio.=" AS SELECT * FROM gioss_consulta_reporte_obligatorio_hf0123_exitoso WHERE codigo_entidad_eapb_generadora='$cod_eapb' AND nombre_archivo_hf='$nombre_zip_sin_consecutivo' ORDER BY numero_secuencia asc, numero_registro asc  ; ";
		}
		else if($estado_validacion_seleccionado=="rechazada")
		{
			$sql_vista_consulta_reporte_obligatorio.=" AS SELECT * FROM gioss_consulta_reporte_obligatorio_hf0123_rechazado WHERE codigo_entidad_eapb_generadora='$cod_eapb' AND nombre_archivo_hf='$nombre_zip_sin_consecutivo' ORDER BY numero_secuencia asc, numero_registro asc  ; ";
		}
		$error_bd_seq="";
		...
		$sql_numero_registros.="SELECT count(*) as contador FROM vcrohf_".$nick_user."_".$tipo_id."_".$identificacion.";  ";
		...
		while($contador_offset<$numero_registros)
		{
			...
			$sql_query_busqueda="";
			$sql_query_busqueda.="SELECT * FROM vcrohf_".$nick_user."_".$tipo_id."_".$identificacion." LIMIT $limite OFFSET $contador_offset;  ";
				...
				*/
				...
				foreach($resultado_query_reporte_obligatorio as $resultado)
				{
					...
					while($cont_orden_campo_hf<$limite_numero_campos_norma)
					{
						...
						$cadena_escribir_linea.=alphanumericAndSpace($resultado["campo_hf_de_numero_orden_".$cont_orden_campo_hf]);
						$cont_orden_campo_hf++;
					}
		...
		//borrando vistas
		$sql_borrar_vistas="";
		$sql_borrar_vistas.=" DROP VIEW vsrohf_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		$sql_borrar_vistas.=" DROP VIEW vcrohf_".$nick_user."_".$tipo_id."_".$identificacion." ; ";
		...
		*/
		...
		if(count($array_rutas_archivos_generados)>0 && $numero_registros>0)
		{
			...
			$mensaje.="<br>Se genero el consolidado de los archivos ERC 0123 de forma comprimida.";
			if(connection_aborted()==false)
			{
		    ...
		    $mail->FromName = "GIOSS";
		    $mail->Subject = "Reporte Obligatorio ERC 0123 ";
