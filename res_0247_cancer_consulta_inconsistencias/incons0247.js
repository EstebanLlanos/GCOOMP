...
function enviar()
{
	...
	{
		var array_nombre_0247=$('#nombre_archivo').val().split(".");
		
		if(array_nombre_0247.length==2 )
		{
			if(array_nombre_0247[1]=="txt")
			{
				document.getElementById('nombre_archivo').value=array_nombre_0247[0];
			}
		}
