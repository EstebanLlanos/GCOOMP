...
$(function() 
{
    ...
    $("#periodo").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Por favor, seleccione el periodo correspondiente al reporte de RIPS<br>'});
    $("#prestador").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Por favor, seleccione el prestador que reportara RIPS<br>'});
    $("#eapb").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Por favor, seleccione la eps a reportar RIPS<br>'});
...
function enviar_formulario()
{
	...
	{
		mensaje_error+="Seleccione el estado de la informaci&oacuten de los reportes RIPS.<br></br>";
	}
	
	if($('#prestador').val()=="none")
	{
		mensaje_error+="Seleccione el prestador para el cual reportara RIPS.<br></br>";
	}
	
	if($('#eapb').val()=="none")
	{
		mensaje_error+="Seleccione la entidad administradora EAPB para el cual reportara RIPS.<br></br>";
	}
