	...
	)//fin condicion if
{
	...
	while($cont_old_campo<$numero_campocross_actual)
	{
		...
		$se_selecciono_algun_valor=false;
		foreach ($array_valor_permitido as $key => $valor_permitido_actual) 
		{
			...
			{
				$se_selecciono_algun_valor=true;
		...
		if($se_selecciono_algun_valor==false && $cont_old_campo!="1" && $fue_seleccionado==true)
		{
			$html_tabla_selectores.="<option value='TODOS' selected>TODOS LOS VALORES PERMITIDOS</option>";
		}//fin if
		else if($se_selecciono_algun_valor==true && $cont_old_campo!="1" && $fue_seleccionado==true)
		{
			$html_tabla_selectores.="<option value='TODOS' >TODOS LOS VALORES PERMITIDOS</option>";
		}//fin else if
