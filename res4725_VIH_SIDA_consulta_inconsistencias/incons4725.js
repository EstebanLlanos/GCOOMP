...
function enviar()
{
	...
	{
		var array_nombre_4725=$('#nombre_archivo').val().split(".");
		
		if(array_nombre_4725.length==2 )
		{
			if(array_nombre_4725[1]=="txt")
			{
				document.getElementById('nombre_archivo').value=array_nombre_4725[0];
			}
		}
	...
	if(busq_fecha_rem.checked==true)
	{
		...
		if(document.getElementById("nombres_archivos_varios"))
		{
			if(document.getElementById("nombres_archivos_varios").value=="none")
			{
...
$(function() 
{
    ...
    $("#prestador").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Por favor, seleccione el prestador que reportara 4725 PyP<br>'});
    $("#eapb").popover({placement: 'right', html: true, trigger: 'hover', title: '<b>Descripcion<b>', content: 'Por favor, seleccione la eps a reportar 4725 PyP<br>'});
