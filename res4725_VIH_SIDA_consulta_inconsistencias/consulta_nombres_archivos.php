...
if(isset($_REQUEST["prestador"]) && isset($_REQUEST["periodo"]) && isset($_REQUEST["year"]) && $_REQUEST["year"]!="" && strlen($_REQUEST["year"])==4 && $_REQUEST["prestador"]!="none" )
{
	...
	//parte base de datos
	$query_consulta="";
	$query_consulta.="SELECT nombre_archivo,numero_secuencia FROM gioss_numero_de_secuencia_r4725_sida WHERE ";
	if($periodo!="none")
	{
	...
	{		
		...
		$selector_numeros_remision.="<option value='none' selected>Seleccione un archivo VIH SIDA</option>";
