						  ...
						  &$coneccionBD, $array_numero_campo_bd)
{
	...
	*/
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    if(trim($campos[$numero_campo])==""
	       && $campo20_contra_fecha_corte_global>0 // es inferior
	       )
	    {
	...
	if(isset($campos[$numero_campo]))
	{
		...
		$cumple_condicion_solo_d_con_rangos_codigo_campo_17=false;
		$empieza_por_d=false;
		if(strlen($campo_n17)==4)
		{
		       ...
		       )
		    {
				    ...
				    )
				{
				    ...
				    $cumple_condicion_solo_d_con_rangos_codigo_campo_17=true;
				}
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    if($campos[$numero_campo]=="" && $campo_ant_45=="98")
	    {
		    $campos[$numero_campo]="98";
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if(trim($campos[$numero_campo])=="" && $campo_ant_86=="1")
	    {
		    $campos[$numero_campo]="1";
	    }	     
	    else if(trim($campos[$numero_campo])=="")
	...
	if(isset($campos[$numero_campo]))
	{
	    $campo_ant_86=$campos[157];
	    //campo obligatorio
	    if(trim($campos[$numero_campo])=="" && ($campo_ant_86=="2" || $campo_ant_86=="98"))
	    {
		    $campos[$numero_campo]="1845-01-01";
	    }
	    else if(trim($campos[$numero_campo])=="")
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    //campo obligatorio
	    if($c112_es_fecha_calendario<0  && trim($campos[$numero_campo])=="")
	    {
		    $campos[$numero_campo]="1";
	    }
	    else if($campo_n112=="1845-01-01"  && trim($campos[$numero_campo])=="")
	    {
		    $campos[$numero_campo]="98";
	    }
	    else if(trim($campos[$numero_campo])=="")
	...
	*/
	...
	if(isset($campos[$numero_campo]))
	{
		...
		if(true)
		{
			...
			//valor permitido
			if( $campos[$numero_campo]!="C" && $campos[$numero_campo]!="S" && $campos[$numero_campo]!="P" && $campos[$numero_campo]!="E" && $campos[$numero_campo]!="N")
			{
				if($errores_campos!="")
				{
					$errores_campos.="|";
	...
	if(isset($campos[$numero_campo]))
	{
	    ...
	    else if( (count($resultado)==0 || !is_array($resultado) ) && $campos[$numero_campo]!="98"    )
	    {
		//si es asi le asigna al campo el mismo codigo pero tal y como se escribe en la base de datos
			$campos[$numero_campo]="98";
	    }//fin if
	...
	if(isset($campos[$numero_campo]))
	{
	   ...
	   (substr($campos[$numero_campo],0,1)=="5" || substr($campos[$numero_campo],0,1)=="8")
	    ...
	    else if( count($resultado)==0 && (trim($campos[$numero_campo])!="98")
	       && ($campo_n83!="98")
	       )
	    {
			if($cod_prestador!="AGRUP_EAPB"){$campos[$numero_campo]=$cod_prestador;}
	...
	if(isset($campos[$numero_campo]))
	{
		...
		else if( count($resultado)==0 && intval($campos[$numero_campo])!=98 )
		{
		    $campos[$numero_campo]="98";
		}
	...
	if(isset($campos[$numero_campo]))
	{
		...
		{			
			//valor permitido
			if( (intval($campos[$numero_campo])<1 || intval($campos[$numero_campo])>3) && intval($campos[$numero_campo])!=99  )
			{
				$campos[$numero_campo]="99";
			}//fin if
			else if(strlen($campos[$numero_campo])>2)
