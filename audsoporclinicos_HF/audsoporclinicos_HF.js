...
function actualizarNombreFile(path_val)
{
  ...
  if (fullPath) 
  {
    ...
    if (filename.indexOf('\\') === 0 || filename.indexOf('/') === 0) 
    {
      ...
      if(document.getElementById('nombre_archivo') )
      {
        document.getElementById('nombre_archivo').innerHTML=filename;
      }

      if(document.getElementById('nombre_archivo_mostrar') )
      {
        document.getElementById('nombre_archivo_mostrar').value=filename;
        Expand(document.getElementById('nombre_archivo_mostrar'));
      }//fin if existe elemento
  }//fin if full path
}//fin function
