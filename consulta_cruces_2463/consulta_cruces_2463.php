...
$smarty->display('consulta_cruces_2463.html.tpl');

/*
INSERT INTO gios_menus_opciones_sistema(id_principal,id_padre,nombre_opcion,descripcion_ayuda,tiene_submenus,ruta_interfaz,prioridad_jerarquica) VALUES ('224','135','Consulta Cruces','',FALSE,'..|consulta_cruces_2463|consulta_cruces_2463.php','33.02');

INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('224','5'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('224','4'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('224','3'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('224','2'); 
INSERT INTO gios_menus_perfiles(id_menu,id_perfil) VALUES ('224','1'); 
*/
 ...
 )//cierra condicional
{
	...
	$resultados_consulta_periodo_informacion_2463=array();
	if($tipo_periodo_tiempo=="trimestral")
	{
	    $consultar_periodo_informacion_2463="";
	    $consultar_periodo_informacion_2463.=" SELECT * FROM gioss_periodo_informacion WHERE cod_periodo_informacion='".$codigo_periodo."'; ";
	    $resultados_consulta_periodo_informacion_2463=$coneccionBD->consultar2_no_crea_cierra($consultar_periodo_informacion_2463);
	}//fin if
	else if($tipo_periodo_tiempo=="mensual")
	{
	    $consultar_periodo_informacion_2463="";
	    $consultar_periodo_informacion_2463.=" SELECT * FROM gioss_periodo_reporte_2463_erc WHERE codigo_periodo='".$codigo_periodo."'; ";
	    $resultados_consulta_periodo_informacion_2463=$coneccionBD->consultar2_no_crea_cierra($consultar_periodo_informacion_2463);
	}//fin if

	if(count($resultados_consulta_periodo_informacion_2463)>0
	   && is_array($resultados_consulta_periodo_informacion_2463)
	   )
	{				    
	    $fecha_inicio_periodo_bd=$resultados_consulta_periodo_informacion_2463[0]["fec_inicio_periodo"];
	    ...
	    $fecha_final_periodo_bd=$resultados_consulta_periodo_informacion_2463[0]["fec_final_periodo"];
		...
		else if($agrupado_o_detallado=="detallado")
		{
			...
			if($cont_campos<119)
			{
				...
				if($es_un_rango==false && $es_una_fecha==false)
				{
					...
					AND fecha_y_hora_validacion='$fecha_y_hora_validacion_identificador'
					AND fecha_de_corte='$fecha_de_corte_identificador'
					AND campo".$cont_campos."='$selector_valor_permitido_campo'
					 ";
				}//fin if
				else if($es_un_rango==true)
				{
					...
					AND fecha_y_hora_validacion='$fecha_y_hora_validacion_identificador'
					AND fecha_de_corte='$fecha_de_corte_identificador'
					AND ( campo".$cont_campos."::numeric BETWEEN '".trim($array_valor_permitido_campo_seleccionado[0])."' AND '".trim($array_valor_permitido_campo_seleccionado[1])."')
					 ";
				...
				else if($es_una_fecha==true)
				{
					...
					AND fecha_y_hora_validacion='$fecha_y_hora_validacion_identificador'
					AND fecha_de_corte='$fecha_de_corte_identificador'
					AND (campo".$cont_campos."::date BETWEEN '1900-12-31' AND '$fecha_de_corte_identificador')
					 ";
		...
		if($mensajes_error=="")
		{
			...
			if($selector_all_or_one_vp=="allvp")
			{
				if($selector_general_o_detallado_cross=="conteo")
				{
					...
					$nombre_campo_orden="";
					$asigno_nombre_campo_orden=false;
					$es_regional=false;
					foreach ($array_campos_cruzados_seleccionados as $key => $numero_campo_cruzado) 
					{
						...
						if(intval($numero_campo_cruzado)<119)
						{
							...
							{
								$nombre_campo_orden="campo".$numero_campo_cruzado;
						...
						else if(intval($numero_campo_cruzado)==119)
						{
							...
							if($asigno_nombre_campo_orden==false)
							{
								$nombre_campo_orden="edad_years";
								$asigno_nombre_campo_orden=true;
							}//fin if asigno nombre campo orden
						}//fin else if
						else if(intval($numero_campo_cruzado)==120)
						{
							$complemento_query_campos_seleccionados_p1.="grupo_edad_quinquenal";
							if($asigno_nombre_campo_orden==false)
							{
								$nombre_campo_orden="grupo_edad_quinquenal";
								$asigno_nombre_campo_orden=true;
							}//fin if asigno nombre campo orden
						}//fin else if
						else if(intval($numero_campo_cruzado)==121)
						{
							$complemento_query_campos_seleccionados_p1.="grupo_etareo";
							if($asigno_nombre_campo_orden==false)
							{
								$nombre_campo_orden="grupo_etareo";
								$asigno_nombre_campo_orden=true;
							}//fin if asigno nombre campo orden
						}//fin else if
						else if(intval($numero_campo_cruzado)==122)
						{
							$complemento_query_campos_seleccionados_p1.="edad_dias";
							if($asigno_nombre_campo_orden==false)
							{
								$nombre_campo_orden="edad_dias";
								$asigno_nombre_campo_orden=true;
							}//fin if asigno nombre campo orden
						}//fin else if
						else if(intval($numero_campo_cruzado)==123)
						{
							$complemento_query_campos_seleccionados_p1.="regional";
							if($asigno_nombre_campo_orden==false)
							{
								$nombre_campo_orden="regional";
								$asigno_nombre_campo_orden=true;
							}//fin if asigno nombre campo orden
							$es_regional=true;
						}//fin else if
					...
					AND fecha_y_hora_validacion='$fecha_y_hora_validacion_identificador'
					AND fecha_de_corte='$fecha_de_corte_identificador'
					group by $complemento_query_campos_seleccionados_p1 ORDER BY $nombre_campo_orden
					 ";
					$resultado_query_conteo_campos_cruzados=$coneccionBD->consultar2_no_crea_cierra($query_conteo_campos_cruzados);
					//echo "query:".$query_conteo_campos_cruzados."<br>";
					echo "<span style='color:white;font-size:8px;'>resultado: ".print_r($resultado_query_conteo_campos_cruzados,true)."</span><br>";

					if($es_regional==true)
					{
						$cont_fix_regional=0;
						while ($cont_fix_regional<count($resultado_query_conteo_campos_cruzados) ) 
						{
							$valor_permitido_regional=strtoupper(trim($resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']) );
							if($valor_permitido_regional==strtoupper("Caribe") || $valor_permitido_regional==strtoupper("CARIBE") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="1";
							}//fin if
							else if($valor_permitido_regional==strtoupper("Centro Oriente") || $valor_permitido_regional==strtoupper("CENTRO ORIENTE") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="2";
							}//fin if
							else if($valor_permitido_regional==strtoupper("Eje Cafetero") || $valor_permitido_regional==strtoupper("EJE CAFETERO") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="3";
							}//fin if
							else if($valor_permitido_regional==strtoupper("Exterior") || $valor_permitido_regional==strtoupper("EXTERIOR") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="4";
							}//fin if
							else if($valor_permitido_regional==strtoupper("Nor Occidente") || $valor_permitido_regional==strtoupper("NOROCCIDENTE") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="5";
							}//fin if
							else if($valor_permitido_regional==strtoupper("Nor Oriente") || $valor_permitido_regional==strtoupper("NORORIENTE") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="6";
							}//fin if
							else if($valor_permitido_regional==strtoupper("Sur Occidente") || $valor_permitido_regional==strtoupper("SUROCCIDENTE") )
							{
								$resultado_query_conteo_campos_cruzados[$cont_fix_regional]['regional']="7";
							}//fin if
							$cont_fix_regional++;
						}//fin while
					}//fin if es regional
						...
						foreach ($array_campos_cruzados_seleccionados as $key => $numero_campo_cruzado) 
						{
							if($numero_campo_base!=$numero_campo_cruzado)
							{
								...
								foreach ($listado_vp_para_los_campos_cruzados[$numero_campo_cruzado]['valores_permitidos_puros'] as $key => $valor_permitido_puro_campo_secundario) 
								{
									...
									{
										//echo "resultado actual: ".print_r($resultado_cruce,true)."<br>";
										
										$array_llaves=array_keys($resultado_cruce);		

										//echo "resultado actual llaves: ".print_r($array_llaves,true)."<br>";								
										//PARTE VERIFICA SI EL VALOR PERMITIDO ES FECHA CALENDARIO MAYOR A 1900 O UN RANGO
										//BASE
										...
										$valor_campo=$resultado_cruce[$nombre_campo_base];
										$array_es_fecha_o_rango=explode("-", $valor_campo);
										...
										if(count($array_es_fecha_o_rango)==3 && strlen($valor_campo)==10 
											...
											&& $resultado_cruce[$nombre_campo_cruzado]==$valor_permitido_puro_campo_secundario
											)
										{											
										...
										$valor_campo=$resultado_cruce[$nombre_campo_cruzado];
										$array_es_fecha_o_rango=explode("-", $valor_campo);										
										if(count($array_es_fecha_o_rango)==3 && strlen($valor_campo)==10
											&& in_array($valor_campo, $listado_vp_para_los_campos_cruzados[$numero_campo_cruzado]['valores_permitidos_puros'])==false 
											&& $resultado_cruce[$nombre_campo_base]==$valor_permitido_puro_campo_base
											)
										{
										...
										$valor_campo2=$resultado_cruce[$nombre_campo_cruzado];
										$array_es_fecha_o_rango2=explode("-", $valor_campo2);
										...
										if($resultado_cruce[$nombre_campo_base]==$valor_permitido_puro_campo_base
											&& $resultado_cruce[$nombre_campo_cruzado]==$valor_permitido_puro_campo_secundario
											)
										{
					...
					foreach ($matriz_organizadora as $key => $filas_vp) 
					{
						...
						if($escribe_titulos_columnas==true)
						{
							...
							{
								//echo print_r($titulo_columna,true)."<br>";
								$array_titulo_columna=explode("_", trim($titulo_columna) );
							...
							$html_resultado_consulta.="<th class='th_class th_class2' style='text-align:center;'>Total Fila</th>";
						...
						foreach ($filas_vp as $key => $columnas_vp) 
						{
							...
							//PARTE ACUMULA LOS VALORES
							$acc_total_fila+=intval($columnas_vp);
							if(isset($acc_total_columna[$key])==true)
							{
								$acc_total_columna[$key]+=intval($columnas_vp);
							}//fin if
							else
							{
								$acc_total_columna[$key]=0+intval($columnas_vp);//inicializa
							}//fin else
							//FIN PARTE ACUMULA LOS VALORES
						}//fin foreach
						$html_resultado_consulta.="<td class='td_class' style='text-align:center;border: 1px solid #4CAF50;'>$acc_total_fila</td>";
					...
					$total=0;
					$html_resultado_consulta.="<tr class='tr_class'>";
					$html_resultado_consulta.="<td class='th_class th_class2' style='text-align:center;'>Total Columna</td>";
					foreach ($acc_total_columna as $key => $acc_total_columna_actual) 
					{
						$total+=intval($acc_total_columna_actual);
						$html_resultado_consulta.="<td class='td_class' style='text-align:center;border: 1px solid #4CAF50;'>$acc_total_columna_actual</td>";
					}//fin foreach	
					$html_resultado_consulta.="<td class='td_class' style='text-align:center;border: 1px solid #4CAF50;'><b>$total</b></td>";
					$html_resultado_consulta.="</tr>";
					//FIN PARTE TOTAL COLUMNA
