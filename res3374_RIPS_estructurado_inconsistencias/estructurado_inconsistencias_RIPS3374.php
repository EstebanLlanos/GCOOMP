...
$smarty->display('estructurado_inconsistencias_RIPS3374.html.tpl');
   ...
   && $_POST["year_de_validacion"]!="" && $_POST["eapb"]!="none")
{
	...
	$nombre_vista_para_estructurado_inconsistencias_1="vestincon1r_".$nick_user."_".$tipo_id."_".$identificacion;
	...
	$sql_vista_inconsistencias_1.=" FROM gioss_reporte_inconsistencia_archivos_rips grir INNER JOIN gioss_tabla_estado_informacion_rips gteir ";
	$sql_vista_inconsistencias_1.=" ON (grir.numero_orden=gteir.numero_secuencia)  WHERE  ";
	$sql_vista_inconsistencias_1.=" (fecha_validacion BETWEEN '".$year."-01-01' AND '".$year."-12-31' ) ";
	...
	$sql_vista_inconsistencias_1.=" order by fecha_validacion,numero_secuencia ; ";
	$error_bd_seq="";
	...
	{
		$nombre_archivo_estructurado_inconsistencias=$cod_eapb."_consolidados_inconsistencias_rips.csv";
		...
		if($clasificacion_inconsistencia=="3_di")
		{
			$query_clasificacion_inconsistencias.=" SELECT * FROM gioss_detalle_inconsistencias_rips t1 ";
			...
			$query_clasificacion_inconsistencias.=" INNER JOIN gioss_tipo_inconsistencias t3 ON (t1.cod_tipo_validacion=t3.tipo_validacion) ";
			$query_clasificacion_inconsistencias.=" ORDER BY cod_detalle_inconsistencia ; ";
		}
		...
		foreach($resultados_clasificacion_inconsistencias as $res_clas_incons)
		{
			...
			if($clasificacion_inconsistencia=="3_di")
			{
				...
				$cod_detalle_inconsistencia=$res_clas_incons["cod_detalle_inconsistencia"];
				$linea_estado_informacion.=$cod_detalle_inconsistencia.",";//
				
				$descripcion_array=array();
				$descripcion_array=explode(";;",$res_clas_incons["descripcion_detalle_inconsistencia"]);
			...
			$year_mes_dia_fin=$year."-01-31";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			...
			$sql_vista_inconsistencias_2.=" AS SELECT DISTINCT nombre_archivo_ct ";
			$sql_vista_inconsistencias_2.=" FROM $nombre_vista_para_estructurado_inconsistencias_1 ";
			$sql_vista_inconsistencias_2.="  WHERE  ";
			$sql_vista_inconsistencias_2.=" (fecha_validacion BETWEEN '".$year_mes_dia_ini."' AND '".$year_mes_dia_fin."' ) ";	
			$sql_vista_inconsistencias_2.=" ; ";
			$error_bd_seq="";
			...
			$nombre_vista_para_estructurado_inconsistencias_3="vestincon3r_".$nick_user."_".$tipo_id."_".$identificacion;
			...
			$sql_vista_inconsistencias_3.=" AS SELECT max(t1.numero_secuencia), t1.nombre_archivo_ct as nombre_rips";
			$sql_vista_inconsistencias_3.=" FROM $nombre_vista_para_estructurado_inconsistencias_1 t1 ";
			$sql_vista_inconsistencias_3.=" INNER JOIN $nombre_vista_para_estructurado_inconsistencias_2 t2 ON (t1.nombre_archivo_ct=t2.nombre_archivo_ct)";
			$sql_vista_inconsistencias_3.="  WHERE  ";
			$sql_vista_inconsistencias_3.=" (t1.fecha_validacion BETWEEN '".$year_mes_dia_ini."' AND '".$year_mes_dia_fin."' ) ";	
			$sql_vista_inconsistencias_3.="GROUP BY nombre_rips ; ";
			$error_bd_seq="";
			...
			$valor_enero=intval($numero_inconsistencias_mes);
			//fin enero
			
			//febrero
			$valor_febrero=0;
			$year_mes_dia_ini=$year."-02-01";
			$year_mes_dia_fin=$year."-02-28";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			$valor_febrero=intval($numero_inconsistencias_mes);
			//fin febrero
			
			//marzo
			$valor_marzo=0;
			$year_mes_dia_ini=$year."-03-01";
			...
			$valor_marzo=intval($numero_inconsistencias_mes);
			//fin marzo
			
			//abril
			$valor_abril=0;
			$year_mes_dia_ini=$year."-04-01";
			$year_mes_dia_fin=$year."-04-30";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			$valor_abril=intval($numero_inconsistencias_mes);
			//fin abril
			
			//mayo
			$valor_mayo=0;
			$year_mes_dia_ini=$year."-05-01";
			$year_mes_dia_fin=$year."-05-31";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			$valor_mayo=intval($numero_inconsistencias_mes);
			//fin mayo
			
			//junio
			$valor_junio=0;
			$year_mes_dia_ini=$year."-06-01";
			...
			//crea una vista uniendo la vista de nombres distintos con su junior numero de secuencia
			$nombre_vista_para_estructurado_inconsistencias_3="vestincon3r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_3="";
			$sql_vista_inconsistencias_3.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_3 ";
			$sql_vista_inconsistencias_3.=" AS SELECT max(t1.numero_secuencia), t1.nombre_archivo_ct as nombre_rips";
			...
			$valor_junio=intval($numero_inconsistencias_mes);
			//fin junio
			
			//julio
			$valor_julio=0;
			$year_mes_dia_ini=$year."-07-01";
			$year_mes_dia_fin=$year."-07-31";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			//crea una vista uniendo la vista de nombres distintos con su julior numero de secuencia
			$nombre_vista_para_estructurado_inconsistencias_3="vestincon3r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_3="";
			$sql_vista_inconsistencias_3.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_3 ";
			$sql_vista_inconsistencias_3.=" AS SELECT max(t1.numero_secuencia), t1.nombre_archivo_ct as nombre_rips";
			...
			$valor_julio=intval($numero_inconsistencias_mes);
			//fin julio
			
			//agosto
			$valor_agosto=0;
			$year_mes_dia_ini=$year."-08-01";
			$year_mes_dia_fin=$year."-08-31";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			//crea una vista uniendo la vista de nombres distintos con su agostor numero de secuencia
			$nombre_vista_para_estructurado_inconsistencias_3="vestincon3r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_3="";
			$sql_vista_inconsistencias_3.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_3 ";
			$sql_vista_inconsistencias_3.=" AS SELECT max(t1.numero_secuencia), t1.nombre_archivo_ct as nombre_rips";
			...
			$valor_agosto=intval($numero_inconsistencias_mes);
			//fin agosto
			
			//septiembre
			$valor_septiembre=0;
			$year_mes_dia_ini=$year."-09-01";
			...
			$valor_septiembre=intval($numero_inconsistencias_mes);
			//fin septiembre
			
			//octubre
			$valor_octubre=0;
			$year_mes_dia_ini=$year."-10-01";
			$year_mes_dia_fin=$year."-10-31";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			//crea una vista uniendo la vista de nombres distintos con su octubrer numero de secuencia
			$nombre_vista_para_estructurado_inconsistencias_3="vestincon3r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_3="";
			$sql_vista_inconsistencias_3.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_3 ";
			$sql_vista_inconsistencias_3.=" AS SELECT max(t1.numero_secuencia), t1.nombre_archivo_ct as nombre_rips";
			...
			$valor_octubre=intval($numero_inconsistencias_mes);
			//fin octubre
			
			//noviembre
			$valor_noviembre=0;
			$year_mes_dia_ini=$year."-11-01";
			$year_mes_dia_fin=$year."-11-30";
			//crea una vista con los nombres de los archivos distintos para el periodo
			$nombre_vista_para_estructurado_inconsistencias_2="vestincon2r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_2="";
			$sql_vista_inconsistencias_2.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_2 ";
			...
			//crea una vista uniendo la vista de nombres distintos con su noviembrer numero de secuencia
			$nombre_vista_para_estructurado_inconsistencias_3="vestincon3r_".$nick_user."_".$tipo_id."_".$identificacion;
			$sql_vista_inconsistencias_3="";
			$sql_vista_inconsistencias_3.="CREATE OR REPLACE VIEW $nombre_vista_para_estructurado_inconsistencias_3 ";
			$sql_vista_inconsistencias_3.=" AS SELECT max(t1.numero_secuencia), t1.nombre_archivo_ct as nombre_rips";
			...
			$valor_noviembre=intval($numero_inconsistencias_mes);
			//fin noviembre
			
			//diciembre
			$valor_diciembre=0;
			$year_mes_dia_ini=$year."-12-01";
			...
			$valor_diciembre=intval($numero_inconsistencias_mes);
			//fin diciembre
			
			$total_inconsistencias_year=0;
			$total_inconsistencias_year=$valor_enero+$valor_febrero+$valor_marzo+$valor_abril+$valor_mayo;
			$total_inconsistencias_year=$total_inconsistencias_year+$valor_junio+$valor_julio+$valor_agosto;
			$total_inconsistencias_year=$total_inconsistencias_year+$valor_septiembre+$valor_octubre+$valor_noviembre+$valor_diciembre;
	...
	if($hubo_resultados)
	{
		...
		$boton_descarga=" <input type=\'button\' value=\'Descargar archivo con el reporte de calidad de datos para RIPS\'  class=\'btn btn-success color_boton\' onclick=\"download_archivo(\'$ruta_archivo_estructurado_inconsistencias\');\"/> ";
