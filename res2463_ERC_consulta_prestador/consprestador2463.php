...
$smarty->display('consprestador2463.html.tpl');
...
{	
	...
	$sql_numero_registros.="SELECT count(*) as contador FROM gioss_tabla_estado_informacion_r2463_erc WHERE codigo_prestador_servicios='$prestador'  ";		
	...
	$sql_vista_estado_informacion.=" AS SELECT * FROM gioss_tabla_estado_informacion_r2463_erc WHERE codigo_prestador_servicios='$prestador'  ";
	...
	while($contador_offset<$numero_registros)
	{
		...
		{
			$nombre_archivo_estado_informacion=$prestador."_estado_info_2463.csv";
	...
	if($hubo_resultados)
	{
		...
		$boton_descarga=" <input type=\'button\' value=\'Descargar archivo con el estado informacion para ERC 0247\'  class=\'btn btn-success color_boton\' onclick=\"download_archivo(\'$ruta_archivo_estado_informacion\');\"/> ";
