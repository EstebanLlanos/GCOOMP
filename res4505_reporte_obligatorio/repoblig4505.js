...
function enviar_formulario()
{
	...
	if($('#periodo').val()=="none")
	{
		mensaje_error+="Seleccione el periodo de los reportes PyP 4505.<br></br>";
	}
	
	if($('#eapb').val()=="none")
	{
		mensaje_error+="Seleccione la entidad administradora EAPB para el cual reportara PyP 4505<br></br>";
	}
