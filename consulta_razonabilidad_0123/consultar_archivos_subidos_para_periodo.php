	...
	)
{
	...
	$query_archivos_subidos_para_analisis.=" SELECT aa.* , eva.nick_usuario FROM gioss_indice_archivo_para_analisis_0123 aa LEFT JOIN gioss_0123_esta_validando_actualmente eva ON (aa.fecha_y_hora_validacion::text = concat_ws(' ',eva.fecha_validacion::text,eva.hora_validacion::text) AND aa.nombre_archivo=aa.nombre_archivo)
	...
	{
		$selector_archivos_subidos.="<option value='none'>Seleccione el Archivo de 0123 que desea analizar</option>";
