...
{	
	...
	if($_POST["tipo_busqueda"]=="1" && isset($_POST["dpto"]) && $_POST["dpto"]!="none")
	{
		...
		$sql_numero_registros.="SELECT count(*) as contador FROM gioss_tabla_estado_informacion_4505 WHERE codigo_eapb='$cod_eapb' AND ";
		...
		$sql_vista_estado_informacion.=" AS SELECT * FROM gioss_tabla_estado_informacion_4505 WHERE  codigo_eapb='$cod_eapb' AND ";
		...
		while($contador_offset<$numero_registros)
		{
			...
			if(count($resultado_query_inconsistencias)>0)
			{
				...
				$nombre_archivo_estado_informacion=$cod_eapb."_estado_info_4505.csv";
	...
	if($_POST["tipo_busqueda"]=="2" && isset($_POST["prestador"]) )
	{
		...
		$sql_numero_registros="";
		$sql_numero_registros.="SELECT count(*) as contador FROM gioss_tabla_estado_informacion_4505 WHERE codigo_eapb='$cod_eapb'  ";
		...
		$sql_vista_estado_informacion="";
		$sql_vista_estado_informacion.="CREATE OR REPLACE VIEW veipyp_".$nick_user."_".$tipo_id."_".$identificacion." ";
		$sql_vista_estado_informacion.=" AS SELECT * FROM gioss_tabla_estado_informacion_4505 WHERE codigo_eapb='$cod_eapb'  ";
		if($prestador!="none")
		{
			$sql_vista_estado_informacion.=" AND ";
